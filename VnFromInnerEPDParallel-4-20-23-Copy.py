...
if(RunIteration == 1):
    ...
    QVectorHistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V1Histograms/QVectorFirstPass" + sys.argv[2] + ".root", "RECREATE")
    ...
    HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V1Histograms/HistogramFirstPass" + sys.argv[2] + ".root", "RECREATE")
...
if(RunIteration == 2):
    ...
    QVectorHistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V1Histograms/QVectorFirstPass.root")
    #HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root")
    HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V1Histograms/HistogramFirstPass.root")
    ...
    #QVectorHistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/QVectorHistogramTest.root", "RECREATE")
    QVectorHistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V1Histograms/QVectorSecondPass" + sys.argv[2] + ".root", "RECREATE")
    QVectorHistogramRootFile.cd()
    ...
    #HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root", "RECREATE")
    HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V1Histograms/HistogramSecondPass" + sys.argv[2] + ".root", "RECREATE")
    HistogramRootFile.cd()
...
if(RunIteration == 3):
    ...
    #QVectorHistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/QVectorHistogramTest.root")
    QVectorHistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V1Histograms/QVectorSecondPass.root")
    #HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root")
    HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V1Histograms/HistogramSecondPass.root")
    ...
    HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V1Histograms/HistogramThirdPass" + sys.argv[2] + ".root", "RECREATE")
    HistogramRootFile.cd()
...
if(RunIteration == 4):
    ...
    QVectorHistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V1Histograms/QVectorSecondPass.root")
    #HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root")
    HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V1Histograms/HistogramThirdPass.root")
    ...
    #HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root", "UPDATE")
    HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V1Histograms/HistogramFourthPass" + sys.argv[2] + ".root", "RECREATE")
    HistogramRootFile.cd()
