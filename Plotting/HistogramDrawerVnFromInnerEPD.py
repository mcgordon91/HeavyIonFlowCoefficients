...
HistogramRootFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V4Histograms/HistogramFourthPassNormal.root")#"/star/data01/pwg/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/5-30-25-V2-HistogramNormalFullDataset.root", "READ")
#SystematicErrorRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/systematicErrors.root","READ")
'''
Histogram = HistogramRootFile.Get("InvariantMassesLambda")

# Change the histogram scope so that it doesn't close when the last file closes
Histogram.SetDirectory(0)

# Build the canvas
CanvasInvariantMassesLambda = ROOT.TCanvas("CanvasInvariantMassesLambda", "", 800, 800)
# Change the scope to be within the file
CanvasInvariantMassesLambda.cd()

CanvasInvariantMassesLambda.SetLogy()
...
# Draw the histogram
CanvasInvariantMassesLambda.Draw()

# Add the histogram to the list of histograms
Canvasas.append(CanvasInvariantMassesLambda)
...
# Histogram = HistogramRootFile.Get("EventCheck")

# # Change the histogram scope so that it doesn't close when the last file closes
# Histogram.SetDirectory(0)

# # Build the canvas
# Canvas_EventCheck = ROOT.TCanvas("Canvas_EventCheck", "", 800, 800)
# # Change the scope to be within the file
# Canvas_EventCheck.cd()
...
# # Draw the histogram
# Canvas_EventCheck.Draw()

# # Add the histogram to the list of histograms
# Canvasas.append(Canvas_EventCheck)
...
# BoxD3 = ROOT.TBox(-2.5, 0.0, 0.16, 6.0)
# BoxD3.SetLineColor(ROOT.kBlack)
# BoxD3.SetLineWidth(2)
# BoxD3.SetFillStyle(0)
...
# CanvasZdVsP = ROOT.TCanvas("CanvasZdVsP", "", 800, 800)
# CanvasZdVsP.cd()
...
# CanvasZtVsP = ROOT.TCanvas("CanvasZtVsP", "", 800, 800)
# CanvasZtVsP.cd()
...
# BoxD27 = ROOT.TBox(0, 0.4, 0.5, 2.0)
# BoxD27.SetLineColor(ROOT.kBlack)
...
# BoxD28 = ROOT.TBox(0, 0.4, 0.5, 1.6)
# BoxD28.SetLineColor(ROOT.kBlack)
...
# BoxD29 = ROOT.TBox(0, 0.4, 0.5, 1.6)
# BoxD29.SetLineColor(ROOT.kBlack)
...
# BoxD30 = ROOT.TBox(0, 0.2, 0.5, 1.6)
# BoxD30.SetLineColor(ROOT.kBlack)
...
# BoxD31 = ROOT.TBox(0, 0.2, 0.5, 1.6)
# BoxD31.SetLineColor(ROOT.kBlack)
...
# BoxD32 = ROOT.TBox(0, 0.8, 0.5, 4.0)
# BoxD32.SetLineColor(ROOT.kBlack)
...
# BoxD33 = ROOT.TBox(0, 1.2, 0.5, 6.0)
# BoxD33.SetLineColor(ROOT.kBlack)
...
# Histogram = HistogramRootFile.Get("FlowStrength")

# Histogram.SetDirectory(0)

# CanvasFlowStrength = ROOT.TCanvas("CanvasFlowStrength", "", 800, 800)
# CanvasFlowStrength.cd()

# CanvasFlowStrength.SetLogz()
...
# CanvasFlowStrength.Draw()

# Canvasas.append(CanvasFlowStrength)
...
# HistogramA.SetTitle("V" + str(nV) + " vs Pt for Protons")
...
HistogramB = HistogramRootFile.Get("VnVsPtProtonHighRapidityCentrality10-40")
...
# HistogramA.SetTitle("V" + str(nV) + " vs Y for Protons")
...
# elif nV == 4:
#     HistogramA.SetAxisRange(-0.008, 0.002, "Y")
# elif nV == 5:
#     HistogramA.SetAxisRange(-0.01, 0.01, "Y")
...
HistogramA.SetTitle("V" + str(nV) + " vs Pt for K+")
...
HistogramA.SetTitle("V" + str(nV) + " vs Y for K+")
...
HistogramA.SetTitle("V" + str(nV) + " vs Pt for Pi+")
...
HistogramA.SetTitle("V" + str(nV) + " vs Y for Pi+")
...
HistogramA.SetTitle("V" + str(nV) + " vs Pt for Deuterons")
...
HistogramA.SetTitle("V" + str(nV) + " vs Y for Deuterons")
...
HistogramA.SetTitle("V" + str(nV) + " vs Pt for Tritons")
...
HistogramA.SetTitle("V" + str(nV) + " vs Y for Tritons")
...
CanvasPrCentHighRap = ROOT.TCanvas("CanvasPrCentHighRap", "", 800, 800)
CanvasPrCentHighRap.cd()

Histogram = HistogramRootFile.Get("DataVnVsCentralityProtonHighRapidityCorrected")
...
if nV == 4:
    Histogram.SetAxisRange(-0.01, 0.0, "Y")

Histogram.Draw("PE 1 X0")

CanvasPrCentHighRap.Draw()

Canvasas.append(CanvasPrCentHighRap)





CanvasPrPtHighRap = ROOT.TCanvas("CanvasPrPtHighRap", "", 800, 800)
CanvasPrPtHighRap.cd()

Histogram = HistogramRootFile.Get("VnVsPtProtonHighRapidityCentrality10-40")
...
CanvasPrPtHighRap.Draw()

Canvasas.append(CanvasPrPtHighRap)




CanvasPrYHighRapComparison = ROOT.TCanvas("CanvasPrYHighRapComparison", "", 800, 800)
CanvasPrYHighRapComparison.cd()
...
if nV == 2:
    Histogram.SetAxisRange(-0.025, 0.044, "Y")

Histogram.Draw("PE 1 X0")

CanvasPrYHighRapComparison.Draw()

Canvasas.append(CanvasPrYHighRapComparison)
