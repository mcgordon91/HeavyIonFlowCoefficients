...
HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root","READ")
...
Histogram = HistogramRootFile.Get("DataV1VsYPsi1ResolutionCorrectedKaonMinus")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsPtForProtonsCentrality0-10")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsPtForProtonsCentrality10-40")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsPtForProtonsCentrality40-60")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsYForProtonsCentrality0-10")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsYForProtonsCentrality10-40")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsYForProtonsCentrality40-60")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsPtForKaonsPlusCentrality0-10")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsPtForKaonsPlusCentrality10-40")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsPtForKaonsPlusCentrality40-60")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsYForKaonsPlusCentrality0-10")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsYForKaonsPlusCentrality10-40")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsYForKaonsPlusCentrality40-60")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsPtForKaonsMinusCentrality0-10")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsPtForKaonsMinusCentrality10-40")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsPtForKaonsMinusCentrality40-60")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsYForKaonsMinusCentrality0-10")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsYForKaonsMinusCentrality10-40")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsYForKaonsMinusCentrality40-60")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsPtForPionsPlusCentrality0-10")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsPtForPionsPlusCentrality10-40")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsPtForPionsPlusCentrality40-60")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsYForPionsPlusCentrality0-10")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsYForPionsPlusCentrality10-40")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"V1VsYForPionsPlusCentrality40-60")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsPtForPionsMinusCentrality0-10")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsPtForPionsMinusCentrality10-40")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsPtForPionsMinusCentrality40-60")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsYForPionsMinusCentrality0-10")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsYForPionsMinusCentrality10-40")
...
Histogram = HistogramRootFile.Get("DataV" + nV +"VsYForPionsMinusCentrality40-60")
...
for index in range(0, len(Canvasas)):
    if len(Canvasas) == 1:
        Canvasas[index].SaveAs('x4-19-23_Test_Plots.pdf)')
        break
