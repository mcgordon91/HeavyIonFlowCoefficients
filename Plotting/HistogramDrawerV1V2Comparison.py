...
# ResolutionFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V1Histograms/Temp/R_11_Normal.root","READ")
# AlternateResolutionFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V1Histograms/R_11_Normal.root","READ")


# Graph = GraphRootFile.Get("/fig2/Graph1D_y1")
# Resolution = ResolutionFile.Get("DataResolutionR11")
# AlternateResolution = AlternateResolutionFile.Get("DataResolutionR11")
...
# AlternateResolution.SetStats(0)
# AlternateResolution.SetLineWidth(3)

# AlternateResolution.GetYaxis().SetTitleOffset(1.5)

# AlternateResolution.SetAxisRange(0.25,0.78,"Y")

# AlternateResolution.SetDirectory(0)
# AlternateResolution.SetLineWidth(3)
# AlternateResolution.SetLineColor(ROOT.kGreen)
# AlternateResolution.SetMarkerStyle(ROOT.kFullTriangleDown)
# AlternateResolution.SetMarkerSize(1.5)
# AlternateResolution.SetMarkerColor(ROOT.kGreen)

# AlternateResolution.SetStats(0)
# AlternateResolution.SetLineWidth(3)

# AlternateResolution.Draw("PE 1 X0")
...
# Legend1.AddEntry(Resolution, "My Work (Cameron's Method)")
# Legend1.AddEntry(AlternateResolution, "My Work (Shaowei's Method)")
...
HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/CumulantCameronFinal.root","READ")
# HistogramRootFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V1Histograms/" + Date + "-V1-HistogramNormalFullDataset.root","READ")
AlternateHistogramRootFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V1Histograms/11-18-24-V1-HistogramNormal.root","READ")
...
HistogramTwo = HistogramRootFile.Get("TwoPartVnVsYForProtonsCentrality10-40")

HistogramTwo.SetDirectory(0)
HistogramTwo.SetLineWidth(8)
HistogramTwo.SetLineColor(ROOT.kBlue)
HistogramTwo.SetMarkerStyle(ROOT.kFullCircle)
HistogramTwo.SetMarkerSize(1.5)
HistogramTwo.SetMarkerColor(ROOT.kBlue)

HistogramTwo.SetTitle("V_{1} vs Y for Protons, 10-40% Centrality")

Canvas2 = ROOT.TCanvas("Canvas2", "", 800, 800)

Canvas2.cd()

HistogramTwo.SetStats(0)

HistogramTwo.GetYaxis().SetTitleOffset(1.5)

HistogramTwo.SetAxisRange(0.0, 0.4, "Y")

HistogramTwo.Draw("PE 1 X0")

HistogramFour = HistogramRootFile.Get("FourPartVnVsYForProtonsCentrality10-40")

HistogramFour.SetDirectory(0)
HistogramFour.SetLineWidth(8)
HistogramFour.SetLineColor(ROOT.kMagenta)
HistogramFour.SetMarkerStyle(ROOT.kFullTriangleUp)
HistogramFour.SetMarkerSize(1.5)
HistogramFour.SetMarkerColor(ROOT.kMagenta)

HistogramFour.Draw("PE 1 X0 SAME")

AlternateHistogram = AlternateHistogramRootFile.Get("DataVnVsYForProtonsCentrality10-40")

AlternateHistogram.SetDirectory(0)
AlternateHistogram.SetLineWidth(8)
AlternateHistogram.SetLineColor(ROOT.kGreen)
AlternateHistogram.SetMarkerStyle(ROOT.kFullTriangleDown)
AlternateHistogram.SetMarkerSize(1.5)
AlternateHistogram.SetMarkerColor(ROOT.kGreen)

AlternateHistogram.Draw("PE 1 X0 SAME")
...
Legend2.AddEntry(HistogramTwo, "Two-Particle Cumulant")
Legend2.AddEntry(HistogramFour, "Four-Particle Cumulant")
Legend2.AddEntry(AlternateHistogram, "Event Plane")
Legend2.AddEntry(NewGraph2, "Literature (Event Plane)")
Legend2.Draw()
...
Histogram = HistogramRootFile.Get("TwoPartVnVsYForKaonsPlusCentrality10-40")
...
Histogram.SetTitle("V_{1} vs Y for K^{+}, 10-40% Centrality")

Histogram.SetAxisRange(0.0, 0.17, "Y")
...
AlternateHistogram = AlternateHistogramRootFile.Get("DataVnVsYForKaonsPlusCentrality10-40")
...
Legend3.AddEntry(Histogram, "Two-Particle Cumulant")
Legend3.AddEntry(AlternateHistogram, "Event Plane")
Legend3.AddEntry(NewGraph3, "Literature (Event Plane)")
Legend3.Draw()
...
Histogram = HistogramRootFile.Get("TwoPartVnVsYForKaonsMinusCentrality10-40")
...
Histogram.SetAxisRange(0.0, 0.12, "Y")
...
AlternateHistogram = AlternateHistogramRootFile.Get("DataVnVsYForKaonsMinusCentrality10-40")
...
Legend4.AddEntry(Histogram, "Two-Particle Cumulant")
Legend4.AddEntry(AlternateHistogram, "Event Plane")
Legend4.AddEntry(NewGraph4, "Literature")
Legend4.Draw()
...
Histogram = HistogramRootFile.Get("TwoPartVnVsYForPionsPlusCentrality10-40")
...
Histogram.SetTitle("V_{1} vs Y for #pi^{+}, 10-40% Centrality")
...
AlternateHistogram = AlternateHistogramRootFile.Get("DataVnVsYForPionsPlusCentrality10-40")
...
Legend5.AddEntry(Histogram, "Two-Particle Cumulant")
Legend5.AddEntry(AlternateHistogram, "Event Plane")
Legend5.AddEntry(NewGraph5, "Literature (Event Plane)")
Legend5.Draw()
...
Histogram = HistogramRootFile.Get("TwoPartVnVsYForPionsMinusCentrality10-40")
...
AlternateHistogram = AlternateHistogramRootFile.Get("DataVnVsYForPionsMinusCentrality10-40")
...
Legend6 = ROOT.TLegend(0.7, 0.8, 0.9, 0.9)
Legend6.AddEntry(Histogram, "Two-Particle Cumulant")
Legend6.AddEntry(AlternateHistogram, "Event Plane")
Legend6.AddEntry(NewGraph6, "Literature (Event Plane)")
Legend6.Draw()
...
Histogram = HistogramRootFile.Get("TwoPartVnVsYForDeuteronsCentrality10-40")
...
Histogram.SetTitle("V_{1} vs Y for Deuterons, 10-40% Centrality")
...
Histogram.SetAxisRange(0.0, 0.65, "Y")

Histogram.Draw("PE 1 X0")

AlternateHistogram = AlternateHistogramRootFile.Get("DataVnVsYForDeuteronsCentrality10-40")
...
Legend6A.AddEntry(Histogram, "Two-Particle Cumulant")
Legend6A.AddEntry(AlternateHistogram, "Event Plane")
Legend6A.AddEntry(NewGraph6A, "Literature (Event Plane)")
Legend6A.Draw()
...
Histogram = HistogramRootFile.Get("TwoPartVnVsYForTritonsCentrality10-40")
...
Histogram.SetTitle("V_{1} vs Y for Tritons, 10-40% Centrality")
...
Histogram.SetAxisRange(0.0, 0.78, "Y")

Histogram.Draw("PE 1 X0")

AlternateHistogram = AlternateHistogramRootFile.Get("DataVnVsYForTritonsCentrality10-40")
...
Legend6B.AddEntry(Histogram, "Two-Particle Cumulant")
Legend6B.AddEntry(AlternateHistogram, "Event Plane")
Legend6B.AddEntry(NewGraph6B, "Literature (Event Plane)")
Legend6B.Draw()
...
GraphRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/LiteratureFiles/HEPData-ins1897294-v1-fig2.root","READ")
ResolutionFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/Temp/R_21_Normal.root","READ")
AlternateResolutionFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/R_21_Normal.root","READ")
...
AlternateHistogram = AlternateResolutionFile.Get("DataResolutionR21")
...
AlternateHistogram.SetStats(0)
AlternateHistogram.SetLineWidth(3)

AlternateHistogram.GetYaxis().SetTitleOffset(1.5)

AlternateHistogram.SetAxisRange(0.0, 0.45,"Y")
...
AlternateHistogram.Draw("PE 1 X0")
...
Legend1A.AddEntry(Histogram, "My Work (Cameron's Method)")
Legend1A.AddEntry(AlternateHistogram, "My Work (Shaowei's Method)")
...
HistogramRootFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/4-10-25-V2-HistogramNormalFullDataset.root","READ")
AlternateHistogramRootFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/5-16-25-V2-HistogramNormalFullDatasetAlternate.root","READ")
# HistogramRootFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/" + Date + "-V2-HistogramNormalFullDataset.root","READ")
...
Legend7.AddEntry(Histogram, "My Work (Cameron's Method)")
Legend7.AddEntry(AlternateHistogram, "My Work (Shaowei's Method)")
...
Histogram8.SetAxisRange(-0.044, -0.015, "Y")
...
Legend8.AddEntry(Histogram, "My Work (Cameron's Method)")
Legend8.AddEntry(AlternateHistogram, "My Work (Shaowei's Method)")
...
AlternateHistogram.Rebin()

Histogram9.SetAxisRange(-0.044, -0.005, "Y")
...
Legend9.AddEntry(Histogram, "My Work (Cameron's Method)")
Legend9.AddEntry(AlternateHistogram, "My Work (Shaowei's Method)")
...
Histogram11.SetAxisRange(-0.037,-0.005,"Y")
...
Legend11.AddEntry(Histogram, "My Work (Cameron's Method)")
Legend11.AddEntry(AlternateHistogram, "My Work (Shaowei's Method)")
