...
# MyResolutionPlotFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V3Histograms/R_31_Normal.root","READ")
# ResolutionPlotFileCameron = ROOT.TFile.Open("/star/u/mcgordon/SystematicsCameronResolution/resolutionInfo_INPUT_3p0GeV_averagedRes.root","READ")
...
MyFile = ROOT.TFile.Open("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNHitsdEdx30High.root","READ")
CameronFile = ROOT.TFile.Open("/star/u/mcgordon/30percentVariations/nhitsdedx_high.picoDst.result.combined.root","READ") 
...
# HistogramA = MyResolutionPlotFile.Get("DataResolutionR31")
...
# HistogramA.SetAxisRange(0.0, 0.01, "Y")
...
# # for index in range(1, HistogramB.GetNbinsX() + 1):
# #     RescaledHistogram1.SetBinContent(index, HistogramB.GetBinContent(index))
# #     RescaledHistogram1.SetBinError(index, HistogramB.GetBinError(index))
...
# # for index in range(1, HistogramB.GetNbinsX() + 1):
# #     RescaledHistogram2.SetBinContent(index, HistogramB.GetBinContent(index))
# #     RescaledHistogram2.SetBinError(index, HistogramB.GetBinError(index))
...
# # for index in range(1, HistogramB.GetNbinsX() + 1):
# #     RescaledHistogram3.SetBinContent(index, HistogramB.GetBinContent(index))
# #     RescaledHistogram3.SetBinError(index, HistogramB.GetBinError(index))
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForKaonsPlusCentrality0-10_px")
...
# Graph = SystematicErrorRootFile.Get("Graph_from_DataVnVsPtForKaonsPlusCentrality0-10_px")
...
# Graph = SystematicErrorRootFile.Get("Graph_from_DataVnVsPtForKaonsPlusCentrality10-40_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForKaonsPlusCentrality40-60_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForKaonsMinusCentrality0-10_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForKaonsMinusCentrality10-40_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForKaonsMinusCentrality40-60_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForPionsPlusCentrality0-10_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForPionsPlusCentrality10-40_px")
...
# Graph = SystematicErrorRootFile.Get("Graph_from_DataVnVsPtForPionsPlusCentrality10-40_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForPionsPlusCentrality40-60_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForPionsMinusCentrality0-10_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForPionsMinusCentrality10-40_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForPionsMinusCentrality40-60_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForDeuteronsCentrality0-10_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForDeuteronsCentrality10-40_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForDeuteronsCentrality40-60_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForTritonsCentrality0-10_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForTritonsCentrality10-40_px")
...
# Histogram = SystematicErrorRootFile.Get("DataVnVsPtForTritonsCentrality40-60_px")
...
HistogramProton1.SetTitle("Scaling Plot of p, d and t (V_{1} vs Centrality) using Event Plane")
...
HistogramProton1.SetAxisRange(0.06, 0.12, "Y")

HistogramProton1.Draw("PE 1 X0")

Histogram = MyFile.Get("DataVnVsCentralityDeuteronCorrected")

NewHistogramScaled1 = ROOT.TH1D("DataVnVsCentralityDeuteronCorrectedScaled", "Scaling Plot of p, d and t; Centrality; V_{1} / A", 12, 0, 12)
...
NewHistogramScaled2 = ROOT.TH1D("DataVnVsCentralityTritonCorrectedScaled", "Scaling Plot of p, d and t; Centrality; V_{1} / A", 12, 0, 12)
...
#     NewGraph10.SetPointError(index, Graph.GetErrorX(index), Graph.GetErrorX(index), Graph.GetErrorY(index), Graph.GetErrorY(index))
...
#     NewGraph11.SetPointError(index, Graph.GetErrorX(index), Graph.GetErrorX(index), Graph.GetErrorY(index), Graph.GetErrorY(index))
...
for index in range(0, len(Canvasas)):
    if len(Canvasas) == 1:
        Canvasas[index].SaveAs('/star/u/mcgordon/30percentVariations/' + Date + '_V3_Literature_Plots.pdf)')
        break
