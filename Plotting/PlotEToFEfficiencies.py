...
ToFFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V1Histograms/ToFEfficiency.root","READ")
# OverallPtVsEtaFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V6Histograms/HistogramFirstPassNormal.root","READ")


Histogram = ToFFile.Get("ProtonEToFDetected")

Histogram.SetDirectory(0)

Histogram.SetTitle("Proton EToF Tracks Detected")

CanvasPrEToF = ROOT.TCanvas("CanvasPrEToF", "", 800, 800)
CanvasPrEToF.cd()

CanvasPrEToF.SetLogz()

CanvasPrEToF.SetRightMargin(0.15)
...
HistogramPr = ROOT.TH2D("ProtonEToFEfficiency", "Proton EToF Efficiencies; #eta; P_{t} (GeV)", 300, -3, 0, 600, 0, 6)

HistogramPr = Histogram1.Clone()

HistogramPr.SetTitle("Proton EToF Efficiencies")
...
Histogram1 = ToFFile.Get("ProtonEToFDetectedRapidity")
Histogram2 = ToFFile.Get("ProtonTPCDetectedRapidity")
HistogramPrRap = ROOT.TH2D("ProtonEToFEfficiencyRapidity", "Proton EToF Efficiencies; #eta; P_{t} (GeV)", 300, -3, 0, 600, 0, 6)

HistogramPrRap = Histogram1.Clone()

HistogramPrRap.SetTitle("Proton EToF Efficiencies")
...
Histogram = ToFFile.Get("KaonPlusEToFDetected")

Histogram.SetDirectory(0)

Histogram.SetTitle("K^{+} EToF Tracks Detected")

CanvasKpEToF = ROOT.TCanvas("CanvasKpEToF", "", 800, 800)
CanvasKpEToF.cd()

CanvasKpEToF.SetLogz()

CanvasKpEToF.SetRightMargin(0.15)
...
HistogramKp = ROOT.TH2D("KaonPlusEToFEfficiency", "K^{+} EToF Efficiencies; #eta; P_{t} (GeV)", 30, -3, 0, 60, 0, 6)

HistogramKp = Histogram1.Clone()

HistogramKp.SetTitle("K^{+} EToF Efficiencies")
...
Histogram1 = ToFFile.Get("KaonPlusEToFDetectedRapidity")
Histogram2 = ToFFile.Get("KaonPlusTPCDetectedRapidity")
HistogramKpRap = ROOT.TH2D("KaonPlusEToFEfficiencyRapidity", "K^{+} EToF Efficiencies; #eta; P_{t} (GeV)", 30, -3, 0, 60, 0, 6)

HistogramKpRap = Histogram1.Clone()

HistogramKpRap.SetTitle("K^{+} EToF Efficiencies")
...
Histogram = ToFFile.Get("KaonMinusEToFDetected")

Histogram.SetDirectory(0)

Histogram.SetTitle("K^{-} EToF Tracks Detected")

CanvasKmEToF = ROOT.TCanvas("CanvasKmEToF", "", 800, 800)
CanvasKmEToF.cd()

CanvasKmEToF.SetLogz()

CanvasKmEToF.SetRightMargin(0.15)
...
HistogramKm = ROOT.TH2D("KaonMinusEToFEfficiency", "K^{-} EToF Efficiencies; #eta; P_{t} (GeV)", 30, -3, 0, 60, 0, 6)

HistogramKm = Histogram1.Clone()

HistogramKm.SetTitle("K^{-} EToF Efficiencies")
...
Histogram1 = ToFFile.Get("KaonMinusEToFDetectedRapidity")
Histogram2 = ToFFile.Get("KaonMinusTPCDetectedRapidity")
HistogramKmRap = ROOT.TH2D("KaonMinusEToFEfficiencyRapidity", "K^{-} EToF Efficiencies; #eta; P_{t} (GeV)", 30, -3, 0, 60, 0, 6)

HistogramKmRap = Histogram1.Clone()

HistogramKmRap.SetTitle("K^{-} EToF Efficiencies")
...
Histogram = ToFFile.Get("PionPlusEToFDetected")

Histogram.SetDirectory(0)

Histogram.SetTitle("#pi^{+} EToF Tracks Detected")

CanvasPpEToF = ROOT.TCanvas("CanvasPpEToF", "", 800, 800)
CanvasPpEToF.cd()

CanvasPpEToF.SetLogz()

CanvasPpEToF.SetRightMargin(0.15)
...
HistogramPp = ROOT.TH2D("PionPlusEToFEfficiency", "#pi^{+} EToF Efficiencies; #eta; P_{t} (GeV)", 300, -3, 0, 600, 0, 6)

HistogramPp = Histogram1.Clone()

HistogramPp.SetTitle("#pi^{+} EToF Efficiencies")
...
Histogram1 = ToFFile.Get("PionPlusEToFDetectedRapidity")
Histogram2 = ToFFile.Get("PionPlusTPCDetectedRapidity")
HistogramPpRap = ROOT.TH2D("PionPlusEToFEfficiencyRapidity", "#pi^{+} EToF Efficiencies; #eta; P_{t} (GeV)", 30, -3, 0, 60, 0, 6)

HistogramPpRap = Histogram1.Clone()

HistogramPpRap.SetTitle("#pi^{+} EToF Efficiencies")
...
Histogram = ToFFile.Get("PionMinusEToFDetected")

Histogram.SetDirectory(0)

Histogram.SetTitle("#pi^{-} EToF Tracks Detected")

CanvasPmEToF = ROOT.TCanvas("CanvasPmEToF", "", 800, 800)
CanvasPmEToF.cd()

CanvasPmEToF.SetLogz()

CanvasPmEToF.SetRightMargin(0.15)
...
HistogramPm = ROOT.TH2D("PionMinusEToFEfficiency", "#pi^{-} EToF Efficiencies; #eta; P_{t} (GeV)", 300, -3, 0, 600, 0, 6)

HistogramPm = Histogram1.Clone()

HistogramPm.SetTitle("#pi^{-} EToF Efficiencies")
...
Histogram1 = ToFFile.Get("PionMinusEToFDetectedRapidity")
Histogram2 = ToFFile.Get("PionMinusTPCDetectedRapidity")
HistogramPmRap = ROOT.TH2D("PionMinusEToFEfficiencyRapidity", "#pi^{-} EToF Efficiencies; #eta; P_{t} (GeV)", 30, -3, 0, 60, 0, 6)

HistogramPmRap = Histogram1.Clone()

HistogramPmRap.SetTitle("#pi^{-} EToF Efficiencies")
...
Histogram = ToFFile.Get("DeuteronEToFDetected")

Histogram.SetDirectory(0)

Histogram.SetTitle("d EToF Tracks Detected")

CanvasDeEToF = ROOT.TCanvas("CanvasDeEToF", "", 800, 800)
CanvasDeEToF.cd()

CanvasDeEToF.SetLogz()

CanvasDeEToF.SetRightMargin(0.15)
...
HistogramDe = ROOT.TH2D("DeuteronEToFEfficiency", "d EToF Efficiencies; #eta; P_{t} (GeV)", 300, -3, 0, 600, 0, 6)

HistogramDe = Histogram1.Clone()

HistogramDe.SetTitle("d EToF Efficiencies")
...
Histogram = ToFFile.Get("TritonEToFDetected")

Histogram.SetDirectory(0)

Histogram.SetTitle("t EToF Tracks Detected")

CanvasTrEToF = ROOT.TCanvas("CanvasTrEToF", "", 800, 800)
CanvasTrEToF.cd()

CanvasTrEToF.SetLogz()

CanvasTrEToF.SetRightMargin(0.15)
...
HistogramTr = ROOT.TH2D("TritonEToFEfficiency", "t EToF Efficiencies; #eta; P_{t} (GeV)", 300, -3, 0, 600, 0, 6)

HistogramTr = Histogram1.Clone()

HistogramTr.SetTitle("t EToF Efficiencies")
...
for index in range(0, len(Canvasas)):
    if len(Canvasas) == 1:
        Canvasas[index].SaveAs('EToFEfficiencies.pdf)')
        break
