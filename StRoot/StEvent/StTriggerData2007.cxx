...
ClassImp(StTriggerData2007)

StTriggerData2007::StTriggerData2007()
{
    mYear=2007;
    mData=0;
}

StTriggerData2007::StTriggerData2007(const TrgDataType2007* data, int run)
{
    mYear=2007;
    mRun = run;
    mData= new TrgDataType2007;
...
StTriggerData2007::~StTriggerData2007() {delete mData;}

unsigned int StTriggerData2007::token() const
{
    return mData->EvtDesc.TrgToken;
}

unsigned int StTriggerData2007::triggerWord() const
{
    return mData->EvtDesc.TriggerWord;
}

unsigned int StTriggerData2007::actionWord() const
{
    return
...
unsigned int StTriggerData2007::numberOfPreXing() const
{
    return mData->EvtDesc.npre;
}

unsigned int StTriggerData2007::numberOfPostXing() const
{
    return mData->EvtDesc.npost;
}

unsigned short StTriggerData2007::busyStatus() const{
    return mData->EvtDesc.modifiedBusyStatus;
}

unsigned short StTriggerData2007::dsmInput() const{
    return mData->EvtDesc.DSMInput;
}

unsigned short StTriggerData2007::trgToken() const{
    return mData->EvtDesc.TrgToken;
}

unsigned short StTriggerData2007::dsmAddress() const{
    return mData->EvtDesc.DSMAddress;
}

unsigned short StTriggerData2007::mAddBits() const{
    return mData->EvtDesc.addBits;
}

unsigned short StTriggerData2007::bcData(int channel) const{
    return mData->TrgSum.DSMdata.BCdata[channel];
}

unsigned short StTriggerData2007::lastDSM(int channel) const{
    return mData->TrgSum.DSMdata.lastDSM[channel];
}

unsigned short StTriggerData2007::tcuBits() const
{
    return mData->EvtDesc.DSMInput;
}

unsigned int StTriggerData2007::bunchCounterHigh() const
{
    return mData->EvtDesc.bunchXing_hi;
}

unsigned int StTriggerData2007::bunchCounterLow() const
{
    return mData->EvtDesc.bunchXing_lo;
}

unsigned int StTriggerData2007::bunchId48Bit() const
{
...
unsigned int StTriggerData2007::bunchId7Bit() const
{
    int b7=0, b7dat; 
...
unsigned int StTriggerData2007::spinBit() const
{
    return (mData->TrgSum.DSMdata.lastDSM[7]/16)%256;
}

unsigned int StTriggerData2007::spinBitYellowFilled() const
{
    unsigned int sb = spinBit();
    return sb%2;
}

unsigned int StTriggerData2007::spinBitYellowUp() const
{
    unsigned int sb = spinBit();
    return (sb/2)%2;
}

unsigned int StTriggerData2007::spinBitYellowDown() const
{
    unsigned int sb = spinBit();
    return (sb/4)%2;
}

unsigned int StTriggerData2007::spinBitYellowUnpol() const
{
    unsigned int sb = spinBit();
    return (sb/8)%2;
}

unsigned int StTriggerData2007::spinBitBlueFilled() const
{
    unsigned int sb = spinBit();
    return (sb/16)%2;
}

unsigned int StTriggerData2007::spinBitBlueUp() const
{
    unsigned int sb = spinBit();
    return (sb/32)%2;
}

unsigned int StTriggerData2007::spinBitBlueDown() const
{
    unsigned int sb = spinBit();
    return (sb/64)%2;
}

unsigned int StTriggerData2007::spinBitBlueUnpol() const
{
    unsigned int sb = spinBit();
    return (sb/128)%2;
}

unsigned short  StTriggerData2007::ctbRaw(int address, int prepost) const
{
    return mData->rawTriggerDet[prepostAddress(prepost)].CTB[address];
}

unsigned short  StTriggerData2007::ctb(int pmt, int prepost) const
{
...
unsigned short StTriggerData2007::ctbTraySlat(int tray, int slat, int prepost) const{
...
unsigned short StTriggerData2007::ctbSum(int prepost) const{
    unsigned short sum=0;
    for (int i=1; i<240; i++){sum+=ctb(i,prepost);}
    return sum;
}

unsigned short StTriggerData2007::bbcADC(StBeamDirection eastwest, int pmt, int prepost) const
{
...
unsigned short StTriggerData2007::bbcTDC(StBeamDirection eastwest, int pmt, int prepost) const
{      
...
unsigned short StTriggerData2007::bbcADCSum(StBeamDirection eastwest, int prepost) const
{
...
unsigned short StTriggerData2007::bbcADCSumLargeTile(StBeamDirection eastwest, int prepost) const
{
    int address = prepostAddress(prepost);
...
unsigned short StTriggerData2007::bbcEarliestTDC(StBeamDirection eastwest, int prepost) const
{
...
unsigned short StTriggerData2007::bbcTimeDifference() const
{
    return mData->TrgSum.DSMdata.VTX[3]%512;
}

unsigned short StTriggerData2007::fpd(StBeamDirection eastwest, int module, int pmt, int prepost) const
{
...
unsigned short StTriggerData2007::fpdSum(StBeamDirection eastwest, int module) const
{
...
unsigned short StTriggerData2007::fpdLayer1DSMRaw(StBeamDirection eastwest, int channel, int prepost) const{
    if (eastwest==east){
...
unsigned short StTriggerData2007::fpdLayer1DSM(StBeamDirection eastwest, int module, int board, int prepost) const{
...
unsigned short StTriggerData2007::fpdLayer2DSMRaw(int channel) const{
    if (channel<8) return mData->TrgSum.DSMdata.FPD[channel];
    return 0;
}

unsigned short StTriggerData2007::fpdLayer2DSM(StBeamDirection eastwest, int module) const{
    static const int dsmmap[2][4]={{3,2,1,0},{7,6,5,4}};
    if (module<4) return mData->TrgSum.DSMdata.FPD[dsmmap[eastwest][module]];
    return 0;
}

unsigned short StTriggerData2007::zdcAtChannel(int channel, int prepost) const
{
...
unsigned short StTriggerData2007::zdcAtAddress(int address, int prepost) const
{
    if (address>=0 && address<16){ return mData->rawTriggerDet[prepostAddress(prepost)].ZDC[address]; }
    return 0;
}

unsigned short StTriggerData2007::zdcUnAttenuated(StBeamDirection eastwest, int prepost) const
{
...
unsigned short StTriggerData2007::zdcAttenuated(StBeamDirection eastwest, int prepost) const
{
...
unsigned short StTriggerData2007::zdcADC(StBeamDirection eastwest, int pmt, int prepost) const
{
...
unsigned short StTriggerData2007::zdcTDC(StBeamDirection eastwest, int prepost) const
{
...
unsigned short StTriggerData2007::zdcHardwareSum(int prepost) const
{
    return mData->rawTriggerDet[prepostAddress(prepost)].ZDC[14];
}

unsigned short StTriggerData2007::zdcSMD(StBeamDirection eastwest, int verthori, int strip, int prepost) const
{
    // new map from Gang Wang (gwang@physics.ucla.edu) 2007 March 26
...
unsigned short StTriggerData2007::bemcLayer1DSM(int channel, int prepost) const {
...
unsigned short StTriggerData2007::eemcLayer1DSM(int channel, int prepost) const {
...
unsigned short StTriggerData2007::emcLayer2DSM(int channel) const {
...
unsigned char StTriggerData2007::bemcHighTower(int patch_id, int prepost) const
{
...
unsigned char StTriggerData2007::bemcJetPatch (int patch_id, int prepost) const
{
    // Unpacking of Bemc trigger data (level 0 DSM input, trigger patches)
    const int m_max_patch=300; // Full barrel
...
unsigned char StTriggerData2007::eemcHighTower(int patch_id, int prepost) const
{
...
unsigned char StTriggerData2007::eemcJetPatch (int patch_id, int prepost) const
{
    // Unpacking of Eemc trigger data (level 0 DSM input, trigger patches)
    const int m_max_patch=90; 
...
unsigned char StTriggerData2007::bemcHighestTowerADC(int prepost) const
{
    // Unpacking of Bemc trigger data (level 0 DSM input, trigger patches)
    const int m_max_patch=300; // Full barrel
    unsigned char h=0;
...
unsigned char StTriggerData2007::eemcHighestTowerADC(int prepost) const
{
    // Unpacking of Eemc trigger data (level 0 DSM input, trigger patches)
    const int m_max_patch=90;
    unsigned char h=0;
...
void StTriggerData2007::dump() const
{
...
char* StTriggerData2007::getTriggerStructure()
{
    return (char*) mData;
}

TrgDataType2007* StTriggerData2007::getTriggerStructure2007()
{
    return mData;
}

int StTriggerData2007::getRawSize() const
{
    int npre = numberOfPreXing();
    int npost = numberOfPostXing();
    int rawSize=sizeof(EvtDescData2007)+sizeof(TrgSumData2007)
        + sizeof(RawTrgDet2007)*(npre+npost+1);
    return  rawSize;
}

unsigned char * StTriggerData2007::getDsm0_EEMC(int prepost) const {
  return   mData->rawTriggerDet[prepostAddress(prepost)].EEMC;
}

unsigned short int  * StTriggerData2007::getDsm1_EEMC(int prepost) const{
  return   mData->rawTriggerDet[prepostAddress(prepost)].EEMClayer1;
}

unsigned short int  * StTriggerData2007::getDsm2_EMC() const{
  return   mData->TrgSum.DSMdata.EMC;
}

unsigned short int  * StTriggerData2007::getDsm3() const{
  return   mData->TrgSum.DSMdata.lastDSM;
}

int StTriggerData2007::L2ResultsOffset(StL2AlgorithmId id) const
{
...
bool StTriggerData2007::isL2Triggered(StL2TriggerResultType id) const
{
  return false;
...
unsigned int StTriggerData2007::l2ResultLength() const
{
