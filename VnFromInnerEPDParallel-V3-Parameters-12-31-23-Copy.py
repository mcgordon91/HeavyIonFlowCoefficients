...
#         TritonTrackCheck.GetXaxis().SetBinLabel(i, TritonTrackLabels[i - 1])
    ...
    for EventNum in range (0, AutreeData.GetEntries()):
        ...
        TrackMultiplicity.Fill(Tracknumber)
...
#             continue
        ...
        if(((InnerEPDQx == 0) and (InnerEPDQy == 0)) or ((OuterEPDQx == 0) and (OuterEPDQy == 0)) or ((InnerTPCQx == 0) and (InnerTPCQy == 0)) or ((OuterTPCQx == 0) and (OuterTPCQy == 0))):
            continue
