...
#     print(Data.ls())
    ...
    for EventNum in range (0, AutreeData.GetEntries()):
        ...
        for index in range(Tracknumber):
            ...
            IsProtonTPC = (abs(NSigmaPr[index]) < NSigmaPrBound) and (p < 2.0)
        ...
        for index in range(Tracknumber):
            ...
            if(tofBeta[index] > 0):
                ...
                if((not TrackIsIDed) and IsKaon): 
                    ...
                    IsGoodKaon = (pt > KaonLowerPt) and (pt < KaonUpperPt) and ((y - yCMShiftShift) > LowerYMinusYCM) and ((y - yCMShiftShift) < UpperYMinusYCM)
                    ...
                    IsGoodPion = (pt > PionLowerPt) and (pt < PionUpperPt) and ((y - yCMShiftShift) > LowerYMinusYCM) and ((y - yCMShiftShift) < UpperYMinusYCM)
                ...
                elif((not TrackIsIDed) and IsProtonToF): 
                    mass = ProtonMass
                    ...
                    IsGoodProton = (pt > ProtonLowerPt) and (pt < ProtonUpperPt) and ((y - yCMShiftShift) > LowerYMinusYCM) and ((y - yCMShiftShift) < UpperYMinusYCM)
...
if(RunIteration == 2):
    ...
    QVectorHistogramRootFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/QVectorSecondPass" + sys.argv[3] + sys.argv[2] + ".root", "RECREATE")
    QVectorHistogramRootFile.cd()
