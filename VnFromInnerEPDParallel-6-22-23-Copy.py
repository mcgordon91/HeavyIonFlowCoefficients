...
if(RunIteration == 1):
    ...
    for entryNum in range (0, AutreeData.GetEntries()):
        ...
        for index in range(len(px)):
            ...
            if((IsDeuteron) and (pt > 2 * ProtonLowerPt) and (pt < 2 * ProtonUpperPt)):
                mass = DeuteronMass
            ...
            elif((IsTriton) and (pt > 3 * ProtonLowerPt) and (pt < 3 * ProtonUpperPt)):
                mass = TritonMass
    ...
    #QVectorHistogramRootFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/QVectorHistogramTest.root", "RECREATE")
    ...
    #HistogramRootFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/HistogramTest.root", "RECREATE")
...
if(RunIteration == 3):
    ...
    #HistogramRootFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/HistogramTest.root", "UPDATE")
