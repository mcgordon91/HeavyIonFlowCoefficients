...
//   TProfile *p_vn_he4 = (TProfile*)file->Get("p_vn_he4");
  ...
  h_vn_kp = new TH1D("h_vn_kp", ";Centrality;v_{"+order_n_str+"}", 6, 0, 6);
  h_vn_km = new TH1D("h_vn_km", ";Centrality;v_{"+order_n_str+"}", 6, 0, 6);
...
//  h_vn_yCM_10to40_km = new TH1D("h_vn_yCM_10to40_km", ";y-y_{mid};v_{"+order_n_str+"}", 5, 0, 1);
