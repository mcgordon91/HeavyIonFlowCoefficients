...
void calculateSystematics(TString order_n_str = "3")
{
  ...
  Variation* Normal = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNormal.root", order_n_str);
   

  Variation* epd_high = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassOuterEPDHigh.root", order_n_str);
  Variation* epd_low = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassOuterEPDLow.root", order_n_str);

    
  Variation* nSigPi_high_20 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNSigmaPion20High.root", order_n_str);
...
//   Variation* zDe_high_20 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/.root", order_n_str);
//   Variation* zDe_low_20  = new Variation("/star/u/mcgordon/SystematicsCameronResolution/.root", order_n_str);
//   Variation* zTr_high_20 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/.root", order_n_str);
//   Variation* zTr_low_20  = new Variation("/star/u/mcgordon/SystematicsCameronResolution/.root", order_n_str);
  ...
  Variation* dca_high_20 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassDCA20High.root", order_n_str);
  Variation* dca_low_20  = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassDCA20Low.root", order_n_str);
  Variation* nhits_high_20 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNHits20High.root", order_n_str);
  Variation* nhits_low_20 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNHits20Low.root", order_n_str);
  Variation* nhitsdEdx_high_20 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNHitsdEdx20High.root", order_n_str);
  //Variation* nhitsdEdx_low_20  = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V3Histograms/", order_n_str);
  Variation* nhitsratio_high_20 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNHitsFitOverNHitsPoss20High.root", order_n_str);
  Variation* nhitsratio_low_20  = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNHitsFitOverNHitsPoss20Low.root", order_n_str);
  ...
  Variation* nSigPi_high_30 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNSigmaPion30High.root", order_n_str);
  Variation* nSigPi_low_30  = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNSigmaPion30Low.root", order_n_str);
  Variation* nSigKa_high_30 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNSigmaKaon30High.root", order_n_str);
  Variation* nSigKa_low_30  = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNSigmaKaon30Low.root", order_n_str);
  Variation* nSigPr_high_30 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNSigmaProton30High.root", order_n_str);
  Variation* nSigPr_low_30  = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNSigmaProton30Low.root", order_n_str);
//   Variation* zDe_high_30 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/.root", order_n_str);
//   Variation* zDe_low_30  = new Variation("/star/u/mcgordon/SystematicsCameronResolution/.root", order_n_str);
//   Variation* zTr_high_30 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/.root", order_n_str);
//   Variation* zTr_low_30  = new Variation("/star/u/mcgordon/SystematicsCameronResolution/.root", order_n_str);
  ...
  Variation* dca_high_30 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassDCA30High.root", order_n_str);
  Variation* dca_low_30  = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassDCA30Low.root", order_n_str);
  Variation* nhits_high_30 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNHits30High.root", order_n_str);
  Variation* nhits_low_30 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNHits30Low.root", order_n_str);
  Variation* nhitsdEdx_high_30 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNHitsdEdx30High.root", order_n_str);
  //Variation* nhitsdEdx_low_30  = new Variation(directory30Percent+"nhitsdEdx_low", order_n_str);
  Variation* nhitsratio_high_30 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNHitsFitOverNHitsPoss30High.root", order_n_str);
  Variation* nhitsratio_low_30  = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassNHitsFitOverNHitsPoss30Low.root", order_n_str);
  Variation* m2Pi_high_30 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassMSquaredPion30High.root", order_n_str);
  ...
  Variation* m2Ka_high_30 = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassMSquaredKaon30High.root", order_n_str);
...
//   CompositeData* zTr = new CompositeData("zTr", Normal, zTr_low_30, zTr_high_30, zTr_low_30, zTr_high_30);
