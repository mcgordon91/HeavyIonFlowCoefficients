...
class TileVector
{
    ...
    public:
        TileVector();
        TileVector(Int_t EPDID, Double_t vx, Double_t vy, Double_t vz, Int_t InnerEPDHighRing, Int_t OuterEPDLowRing);
...
TileVector::TileVector(Int_t EPDID, Double_t vx, Double_t vy, Double_t vz, Int_t InnerEPDHighRing, Int_t OuterEPDLowRing)
{
    this->EPDID = EPDID;
    this->vx = vx;
    this->vy = vy;
