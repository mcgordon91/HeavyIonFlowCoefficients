...
void printHistos(TH2D *h2, TString species)
{
  ...
  */
  ...
  Double_t lowBound = -1.0; // Default values
  Double_t highBound = 1.0;
  ...
  for (int pBin = /*16*/pBinStart; pBin <= nBins; pBin++)
    {
      ...
      text = new TPaveText(0.65, 0.83, 0.89, 0.88, "NB NDC");
...
void testPurity()
{
  ...
  TString fileName = "/star/data01/pwg/mcgordon/VnFromEPD/V1Histograms/HistogramFirstPassDandTNormal.root";
