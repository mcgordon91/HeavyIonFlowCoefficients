...
int main(int argc, char *argv[])
{
  ...
  TProfile2D *p2_vn_yCM_cent_de_alt = new TProfile2D("p2_vn_yCM_cent_de_alt", "Deuteron v_{"+ORDER_N_STR+"};Centrality;y-y_{mid}", CENT_BINS, FIRST_CENT, FIRST_CENT+CENT_BINS, 20, -1, 1);
  ...
  TProfile2D *p2_vn_yCM_cent_tr_alt = new TProfile2D("p2_vn_yCM_cent_tr_alt", "Triton v_{"+ORDER_N_STR+"};Centrality;y-y_{mid}", CENT_BINS, FIRST_CENT, FIRST_CENT+CENT_BINS, 20, -1, 1);
  ...
  TProfile2D *p2_vn_yCM_cent_he3_alt = new TProfile2D("p2_vn_yCM_cent_he3_alt", "Helium-3 v_{"+ORDER_N_STR+"};Centrality;y-y_{mid}", CENT_BINS, FIRST_CENT, FIRST_CENT+CENT_BINS, 20, -1, 1);
  p2_vn_yCM_cent_he3_alt->Sumw2();
  TProfile2D *p2_vn_yCM_cent_he3_noEff = new TProfile2D("p2_vn_yCM_cent_he3_noEff", "Helium-3 v_{"+ORDER_N_STR+"};Centrality;y-y_{mid}", CENT_BINS, FIRST_CENT, FIRST_CENT+CENT_BINS, 20, -1, 1);
  ...
  TProfile2D *p2_vn_yCM_cent_he4_alt = new TProfile2D("p2_vn_yCM_cent_he4_alt", "Helium-4 v_{"+ORDER_N_STR+"};Centrality;y-y_{mid}", CENT_BINS, FIRST_CENT, FIRST_CENT+CENT_BINS, 20, -1, 1);
  p2_vn_yCM_cent_he4_alt->Sumw2();
  TProfile2D *p2_vn_yCM_cent_he4_noEff = new TProfile2D("p2_vn_yCM_cent_he4_noEff", "Helium-3 v_{"+ORDER_N_STR+"};Centrality;y-y_{mid}", CENT_BINS, FIRST_CENT, FIRST_CENT+CENT_BINS, 20, -1, 1);
	  ...
	  if (s_charge != 0)
	      ...
	      else if(helium3) // PID Helium3
		{
		  ...
		  //h2_pT_vs_yCM_he3->Fill(d_rapidity - Y_MID, d_pT);
                  ...
                  he3_eff = he3_eff*(Float_t)h2_tracking_he3->GetBinContent(h2_tracking_he3->FindBin(d_rapidity - Y_MID, 2*d_pT));
                  ...
                  he3_eff = he3_eff*(Float_t)tpc_he3->GetBinContent(tpc_he3->FindBin(2*d_mom));
	      ...
	      else if(helium4) // PID Helium4
		{
		  ...
		  h2_pT_vs_yCM_he4->Fill(d_rapidity - Y_MID, 2*d_pT);
                  he4_eff = he4_eff*(Float_t)h2_tracking_he4->GetBinContent(h2_tracking_he4->FindBin(d_rapidity - Y_MID, 2*d_pT));
                  he4_eff = he4_eff*(Float_t)tpc_he4->GetBinContent(tpc_he4->FindBin(2*d_mom));
	      ...
	      for (UInt_t j = 0; j < eventInfo.tpcParticles.size(); j++)
		{
		  ...
		  // TRITON
			  ...
			  jthpT > configs.pt_yDep_tr_low && jthpT < configs.pt_yDep_tr_high)
			{
			  ...
			  jthRapidity - Y_MID > 0.0 && jthRapidity - Y_MID < 0.6)
			{
			  p_vn_tr_y0to0p6->Fill(centID, TMath::Cos(ORDER_N * (jthPhi - psi)) / (resolution ),1./tpcEfficiency); 
			}
			  ...
			  jthRapidity - Y_MID > 0.6 && jthRapidity - Y_MID < 1.0)
			{
			  p_vn_tr_y0p6to1p0->Fill(centID, TMath::Cos(ORDER_N * (jthPhi - psi)) / (resolution ),1./tpcEfficiency); 
			}
			  ...
			  jthRapidity/Y_BEAM > -1.0 && jthRapidity/Y_BEAM < 0.0)
			{
			  p2_vn_yOverYbeam_cent_tr->Fill(centID, jthRapidity/Y_BEAM, TMath::Cos(ORDER_N * (jthPhi - psi)) / (resolution ),1./tpcEfficiency);
			}
		  ...
		  // HELIUM3
				...
				p2_vn_yCM_cent_he3->Fill(centID, jthRapidity - Y_MID, TMath::Cos(ORDER_N * (jthPhi - psi)) / (resolution ),1./jtheff);
				 ...
				 // vn vs pT
			  	...
			  	h2_dndDeltaPhi_vs_cent_he3->Fill(centID, jthPhi - psi);
                          ...
                          //he3_eff = he3_eff*(Float_t)tpc_he3->GetBinContent(tpc_he3->FindBin(2*jthmom));
                          //std::cout << "2648: he3 jtheff: " << jtheff << std::endl;
			}
                      ...
                      if(2*jthpT>He3ptLowCut && 2*jthpT<He3ptHighCut && jthRapidity - Y_MID>yLowCut && jthRapidity - Y_MID<yHighCut  && DyBin != -1 && he3_eff>0.) 
			{
		      ...
		      if(jtheff>0.01) 
		      {
		         if (2*jthpT >= configs.pt_yMid_he3_low && 2*jthpT <= configs.pt_yMid_he3_high &&
		   	  jthRapidity - Y_MID > configs.yCM_yMid_he3_low && jthRapidity - Y_MID < configs.yCM_yMid_he3_high)
		   	  {
		   	    p2_vn_pT_cent_he3_yMid->Fill(centID, 2*jthpT, TMath::Cos(ORDER_N * (jthPhi - psi)) / (resolution ),1./jtheff);
		   	  }
		           if (2*jthpT >= configs.pt_yFor_he3_low && 2*jthpT <= configs.pt_yFor_he3_high &&
		   	    jthRapidity - Y_MID > configs.yCM_yFor_he3_low && jthRapidity - Y_MID < configs.yCM_yFor_he3_high)
		   	  {
		   	    p2_vn_pT_cent_he3_yFor->Fill(centID, 2*jthpT, TMath::Cos(ORDER_N * (jthPhi - psi)) / (resolution ),1./jtheff);
		   	  }
		           if (2*jthpT >= configs.pt_yExt_he3_low && 2*jthpT <= configs.pt_yExt_he3_high &&
		   	    jthRapidity - Y_MID > configs.yCM_yExt_he3_low && jthRapidity - Y_MID < configs.yCM_yExt_he3_high)
		   	  {
		   	    p2_vn_pT_cent_he3_yExt->Fill(centID, 2*jthpT, TMath::Cos(ORDER_N * (jthPhi - psi)) / (resolution ),1./jtheff);
		   	  }
		           if (2*jthpT >= configs.pt_yEnd_he3_low && 2*jthpT <= configs.pt_yEnd_he3_high &&
		   	    jthRapidity - Y_MID > configs.yCM_yEnd_he3_low && jthRapidity - Y_MID < configs.yCM_yEnd_he3_high)
		   	  {
		  ...
		  // HELIUM4
			  ...
			  jthRapidity - Y_MID > configs.yCM_norm_he4_low && jthRapidity - Y_MID < configs.yCM_norm_he4_high)
			{
			  ...
			  if(jtheff>0.01){
			    ...
			    p_vn_he4->Fill(centID, TMath::Cos(ORDER_N * (jthPhi - psi)) / (resolution ),1./tpcEfficiency); 
			    p2_vn_pT_cent_he4->Fill(centID, 2*jthpT, TMath::Cos(ORDER_N * (jthPhi - psi)) / (resolution ),1./tpcEfficiency);
			    p2_vn_KT_cent_he4->Fill(centID, jthKT, TMath::Cos(ORDER_N * (jthPhi - psi)) / (resolution ),1./tpcEfficiency);
		      ...
		      if (jtheff>0.01){
		        ...
		        if (2*jthpT >= configs.pt_norm_he4_low && 2*jthpT <= configs.pt_norm_he4_high &&
		  	    jthRapidity - Y_MID > 0.0 && jthRapidity - Y_MID < 0.6)
		  	  {
		  	    p_vn_he4_y0to0p6->Fill(centID, TMath::Cos(ORDER_N * (jthPhi - psi)) / (resolution ),1./tpcEfficiency); 
		  	  }
		        ...
		        if (2*jthpT >= configs.pt_norm_he4_low && 2*jthpT <= configs.pt_norm_he4_high &&
		  	    jthRapidity - Y_MID > 0.6 && jthRapidity - Y_MID < 1.0)
		  	  {
		  	    p_vn_he4_y0p6to1p0->Fill(centID, TMath::Cos(ORDER_N * (jthPhi - psi)) / (resolution ),1./tpcEfficiency); 
		  	  }
		        ...
		        if (2*jthpT >= configs.pt_norm_he4_low && 2*jthpT <= configs.pt_norm_he4_high &&
		  	    jthRapidity/Y_BEAM > -1.0 && jthRapidity/Y_BEAM < 0.0)
		  	  {
		  	    p2_vn_yOverYbeam_cent_he4->Fill(centID, jthRapidity/Y_BEAM, TMath::Cos(ORDER_N * (jthPhi - psi)) / (resolution ),1./tpcEfficiency);
		  	  }
			}
		    }
