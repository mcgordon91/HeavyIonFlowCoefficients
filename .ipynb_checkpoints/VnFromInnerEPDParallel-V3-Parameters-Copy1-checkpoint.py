...
#     print(AutreeData.Print())
    ...
    rdf = ROOT.RDataFrame("Autree", Data)
    ...
    rdf.Define("vr", sqrt(pow(Vx, 2) + pow(Vy + 2, 2)), {"Vx", "Vy"}).Filter("vr > RVertexBound").Filter("Vz <= ZVertexLowerBound)").Filter("Vz >= ZVertexUpperBound")
