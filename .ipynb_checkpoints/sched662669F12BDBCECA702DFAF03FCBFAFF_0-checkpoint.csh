#!/bin/csh
# -------------------------------------- 
# Script generated on Sun Apr 16 23:17:12 EDT 2023 by the Simple Unified Meta Scheduler 1.10.50 and submitted with:
# cd /star/u/mcgordon/V1FromEPD; condor_submit -verbose /star/u/mcgordon/V1FromEPD/sched662669F12BDBCECA702DFAF03FCBFAFF_0_56.condor
# --------------------------------------
...
setenv FILEBASENAME "FXT_3p0GeV_SL20d_2018_0"
setenv FILELIST "/star/u/mcgordon/V1FromEPD/sched662669F12BDBCECA702DFAF03FCBFAFF_0.list"
setenv FILELIST_ALL "/star/u/mcgordon/V1FromEPD/sched662669F12BDBCECA702DFAF03FCBFAFF.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "662669F12BDBCECA702DFAF03FCBFAFF_0"
setenv JOBINDEX "0"
setenv LOGGING "STD"
setenv REQUESTID "662669F12BDBCECA702DFAF03FCBFAFF"
setenv SUBMITATTEMPT "1"
setenv SUBMITTINGDIRECTORY "/star/u/mcgordon/V1FromEPD"
setenv SUBMITTINGNODE "rcas6015.rcf.bnl.gov"
setenv SUBMIT_TIME "2023-04-17 03:17:12"
...
setenv INPUTFILE0 "/star/data01/pwg/cracz/Data_3p0GeV_FXT/FXT_3p0GeV_SL20d_2018_0.root"
...
#import packages 
/usr/bin/unzip /star/u/mcgordon/V1FromEPD/sched662669F12BDBCECA702DFAF03FCBFAFF_0.package.zip -d $SCRATCH
...
# User command BEGIN ----------------------------->
    ...
    setup 64b
    setup root 6.16.00
    python V1FromInnerEPD.py $INPUTFILE0 $JOBID
