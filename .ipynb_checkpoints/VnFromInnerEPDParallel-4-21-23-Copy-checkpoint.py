...
if(RunIteration == 2):
    ...
    QVectorHistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/QVectorFirstPassNormal.root")
    #HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root")
    HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/HistogramFirstPassNormal.root")
...
if(RunIteration == 3):
    ...
    #QVectorHistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/QVectorHistogramTest.root")
    QVectorHistogramFileFirst = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/QVectorFirstPassNormal.root")
    QVectorHistogramFileSecond = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/QVectorSecondPassNormal.root")
    #HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root")
    HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/HistogramSecondPassNormal.root")
...
if(RunIteration == 4):
    ...
    #QVectorHistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/QVectorHistogramTest.root")
    QVectorHistogramFileFirst = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/QVectorFirstPassNormal.root")
    QVectorHistogramFileSecond = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/QVectorSecondPassNormal.root")
    #HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root")
    HistogramFile = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/HistogramThirdPassNormal.root")
