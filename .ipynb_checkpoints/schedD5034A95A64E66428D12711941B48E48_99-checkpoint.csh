#!/bin/csh
# -------------------------------------- 
# Script generated on Fri Jun 16 20:58:52 EDT 2023 by the Simple Unified Meta Scheduler 1.10.50 and submitted with:
# cd /star/u/mcgordon/VnFromEPD; condor_submit -verbose /star/u/mcgordon/VnFromEPD/schedD5034A95A64E66428D12711941B48E48_57_156.condor
# --------------------------------------
...
setenv FILEBASENAME "FXT_3p0GeV_SL20d_2018_99"
setenv FILELIST "/star/u/mcgordon/VnFromEPD/schedD5034A95A64E66428D12711941B48E48_99.list"
setenv FILELIST_ALL "/star/u/mcgordon/VnFromEPD/schedD5034A95A64E66428D12711941B48E48.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "D5034A95A64E66428D12711941B48E48_99"
setenv JOBINDEX "99"
setenv LOGGING "STD"
setenv REQUESTID "D5034A95A64E66428D12711941B48E48"
setenv SUBMITATTEMPT "1"
setenv SUBMITTINGDIRECTORY "/star/u/mcgordon/VnFromEPD"
setenv SUBMITTINGNODE "rcas6015.rcf.bnl.gov"
setenv SUBMIT_TIME "2023-06-17 00:58:52"
...
setenv INPUTFILE0 "/star/data01/pwg/cracz/Data_3p0GeV_FXT/FXT_3p0GeV_SL20d_2018_99.root"
...
#import packages 
/usr/bin/unzip /star/u/mcgordon/VnFromEPD/schedD5034A95A64E66428D12711941B48E48_0.package.zip -d $SCRATCH
...
# User command BEGIN ----------------------------->
    ...
    setup 64b
    setup root 6.16.00
    python VnFromInnerEPDParallel.py $INPUTFILE0 $JOBID
