...
ResolutionFile1 = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V1Histograms/R_11_" + sys.argv[1] + "NewDataset.root", "RECREATE")
ResolutionFile2 = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/R_21_" + sys.argv[1] + "NewDataset.root", "RECREATE")
ResolutionFile3 = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V3Histograms/R_31_" + sys.argv[1] + "NewDataset.root", "RECREATE")
ResolutionFile4 = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V4Histograms/R_41_" + sys.argv[1] + "NewDataset.root", "RECREATE")
ResolutionFile5 = ROOT.TFile.Open("/star/data01/pwg/mcgordon/VnFromEPD/V5Histograms/R_51_" + sys.argv[1] + "NewDataset.root", "RECREATE")
