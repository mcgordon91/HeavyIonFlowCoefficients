...
HistoD54A = ROOT.TH1F("DataResolutionR11", "R_{11}; Centrality; Resolution", NumberOfCentralityBins, array('d', CentralityBinEdges))
HistoD54A.Sumw2()

HistoD54B = ROOT.TH1F("DataResolutionR21", "R_{21}; Centrality; Resolution", NumberOfCentralityBins, array('d', CentralityBinEdges))
HistoD54B.Sumw2()

HistoD54C = ROOT.TH1F("DataResolutionR31", "R_{31}; Centrality; Resolution", NumberOfCentralityBins, array('d', CentralityBinEdges))
HistoD54C.Sumw2()

HistoD54D = ROOT.TH1F("DataResolutionR41", "R_{41}; Centrality; Resolution", NumberOfCentralityBins, array('d', CentralityBinEdges))
HistoD54D.Sumw2()

HistoD54E = ROOT.TH1F("DataResolutionR51", "R_{51}; Centrality; Resolution", NumberOfCentralityBins, array('d', CentralityBinEdges))
HistoD54E.Sumw2()
