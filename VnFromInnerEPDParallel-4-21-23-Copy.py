...
if(os.path.exists("/star/u/mcgordon/VnFromEPD/V" + nV + "Histograms/HistogramThirdPass.root")):
    RunIteration = 4
elif(os.path.exists("/star/u/mcgordon/VnFromEPD/V" + nV + "Histograms/HistogramSecondPass.root")):
    RunIteration = 3
elif(os.path.exists("/star/u/mcgordon/VnFromEPD/V" + nV +"Histograms/HistogramFirstPass.root")):
    RunIteration = 2
else:
    RunIteration = 1
...
if(RunIteration == 1):
    ...
    HistoD36 = ROOT.TH1F("DataPsi1RawOuterEPD", "Reaction Plane Angle, Psi_1, Outer EPD (Data); Psi; Events", 75, -3.5, 3.5)
    HistoD36.Sumw2()
    ...
    QVectorHistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + nV + "Histograms/QVectorFirstPass" + sys.argv[2] + ".root", "RECREATE")
    ...
    HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + nV + "Histograms/HistogramFirstPass" + sys.argv[2] + ".root", "RECREATE")
...
if(RunIteration == 2):
    ...
    QVectorHistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + nV + "Histograms/QVectorFirstPass.root")
    #HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root")
    HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + nV + "Histograms/HistogramFirstPass.root")
    ...
    HistoD37 = ROOT.TH1F("DataPsi1RecenteredOuterEPD", "Reaction Plane Angle, Psi_1, Outer EPD (Data); Psi; Events", 75, -3.5, 3.5)
    HistoD37.Sumw2()    
    ...
    #QVectorHistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/QVectorHistogramTest.root", "RECREATE")
    QVectorHistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + nV + "Histograms/QVectorSecondPass" + sys.argv[2] + ".root", "RECREATE")
    QVectorHistogramRootFile.cd()
    ...
    #HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root", "RECREATE")
    HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + nV + "Histograms/HistogramSecondPass" + sys.argv[2] + ".root", "RECREATE")
    HistogramRootFile.cd()
...
if(RunIteration == 3):
    ...
    #QVectorHistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/QVectorHistogramTest.root")
    QVectorHistogramFileFirst = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + nV + "Histograms/QVectorFirstPass.root")
    QVectorHistogramFileSecond = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + nV + "Histograms/QVectorSecondPass.root")
    #HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root")
    HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + nV + "Histograms/HistogramSecondPass.root")
        
        
    HistoD35 = ROOT.TH1F("DataPsi1RecenteredAndShiftedInnerEPD", "Reaction Plane Angle, Psi_1 Inner EPD (Data); Psi; Events", 75, -3.5, 3.5)
    HistoD35.Sumw2()

    HistoD38 = ROOT.TH1F("DataPsi1RecenteredAndShiftedOuterEPD", "Reaction Plane Angle, Psi_1, Outer EPD (Data); Psi; Events", 75, -3.5, 3.5)
    HistoD38.Sumw2()
    ...
    for entryNum in range (0, AutreeData.GetEntries()):
        ...
        for j in range(1, FourierCorrectionTerms + 1):
            ...
            FourierCorrectionTermTPC += (2/(j*nPsi))*(InnerEPDSineAverageJth*cos(j*nPsi*PsiInnerEPDRecentered) + InnerEPDCosineAverageJth*sin(j*nPsi*PsiInnerEPDRecentered))
    ...
    HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + nV + "Histograms/HistogramThirdPass" + sys.argv[2] + ".root", "RECREATE")
    HistogramRootFile.cd()
...
if(RunIteration == 4):
    ...
    QVectorHistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + nV + "Histograms/QVectorFirstPass.root")
    #HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root")
    HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + nV + "Histograms/HistogramThirdPass.root")
    ...
    for entryNum in range (0, AutreeData.GetEntries()):
        ...
        for j in range(1, FourierCorrectionTerms + 1):
            InnerEPDSineAverageJth = QVectorHistogramFile.Get("InnerEPDSineAverages").GetBinContent(j)
            InnerEPDCosineAverageJth = QVectorHistogramFile.Get("InnerEPDCosineAverages").GetBinContent(j)
            OuterEPDSineAverageJth = QVectorHistogramFile.Get("OuterEPDSineAverages").GetBinContent(j)
            OuterEPDCosineAverageJth = QVectorHistogramFile.Get("OuterEPDCosineAverages").GetBinContent(j)
            TPCSineAverageJth = QVectorHistogramFile.Get("TPCSineAverages").GetBinContent(j)
            TPCCosineAverageJth = QVectorHistogramFile.Get("TPCCosineAverages").GetBinContent(j)
    ...
    #HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root", "UPDATE")
    HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + nV + "Histograms/HistogramFourthPass" + sys.argv[2] + ".root", "RECREATE")
    HistogramRootFile.cd()
