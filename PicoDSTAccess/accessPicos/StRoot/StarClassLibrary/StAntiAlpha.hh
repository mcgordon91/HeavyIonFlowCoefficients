/***************************************************************************
 *
 * $Id: StAntiAlpha.hh,v 1.1 2011/03/25 18:17:44 jwebb Exp $
 *
...
public:
    static StAntiAlpha* instance() {return &mAntiAlpha;}
    static StAntiAlpha* alpha() {return &mAntiAlpha;}
    
private:
    static StAntiAlpha mAntiAlpha;
    
    StAntiAlpha(const string  &  aName,  
	    double           mass,     
	    double           width,
	    double           charge,   
	    int              iSpin,
