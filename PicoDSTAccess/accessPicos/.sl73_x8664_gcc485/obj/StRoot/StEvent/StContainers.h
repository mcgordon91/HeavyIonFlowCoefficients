...
//______________________________________________________________
class StEpdHit;
typedef StEpdHit**            StEpdHitIterator;
typedef StEpdHit * const * const_StEpdHitIterator;

class StPtrVecEpdHit : public StRefArray 
{ 
public: 
StPtrVecEpdHit(Int_t sz=0):StRefArray(sz){};
StPtrVecEpdHit(const StPtrVecEpdHit &from):StRefArray(from){};
virtual        ~StPtrVecEpdHit(){};

 StEpdHit * const &at(Int_t idx) const {return (StEpdHit  * const &)fV[idx];}
 StEpdHit *       &at(Int_t idx)       {return (StEpdHit  *       &)fV[idx];}

 StEpdHit * const &front()       const {return (StEpdHit  * const &)fV.front();}
 StEpdHit *       &front()             {return (StEpdHit  *       &)fV.front();}

 StEpdHit * const &back()        const {return (StEpdHit  * const &)fV.back();}
 StEpdHit *       &back()              {return (StEpdHit  *       &)fV.back();}

const_StEpdHitIterator begin() const {return (const_StEpdHitIterator)&(*(fV.begin()));}
      StEpdHitIterator begin()       {return (      StEpdHitIterator)&(*(fV.begin()));}
const_StEpdHitIterator end()   const {return (const_StEpdHitIterator)&(*(fV.end()));}
      StEpdHitIterator end()         {return (      StEpdHitIterator)&(*(fV.end()));}
      StEpdHitIterator erase(StEpdHitIterator  it)
      {return (StEpdHitIterator)Erase((TObject**)it,0);}
      StEpdHitIterator erase(StEpdHitIterator fst,StEpdHitIterator lst)
      {return (StEpdHitIterator)Erase((TObject**)fst,(TObject**)lst,0);}
      StEpdHit *       &operator[](Int_t i)       {return at(i);}
      StEpdHit * const &operator[](Int_t i) const {return at(i);}
void  push_back(const StEpdHit * const to){fV.push_back((TObject*const)to);}

ClassDef(StPtrVecEpdHit ,1) 
};


class StSPtrVecEpdHit : public StStrArray 
{ 
public: 
StSPtrVecEpdHit(Int_t sz=0):StStrArray(sz){};
StSPtrVecEpdHit(const StSPtrVecEpdHit &from):StStrArray(from){};
...
const_StEpdHitIterator end()   const {return (const_StEpdHitIterator)&(*(fV.end()));}
      StEpdHitIterator end()         {return (      StEpdHitIterator)&(*(fV.end()));}
      StEpdHitIterator erase(StEpdHitIterator  it)
      {return (StEpdHitIterator)Erase((TObject**)it,1);}
      StEpdHitIterator erase(StEpdHitIterator fst,StEpdHitIterator lst)
      {return (StEpdHitIterator)Erase((TObject**)fst,(TObject**)lst,1);}
      StEpdHit *       &operator[](Int_t i)       {return at(i);}
      StEpdHit * const &operator[](Int_t i) const {return at(i);}
void  push_back(const StEpdHit *to){StStrArray::push_back((TObject*)to);}

ClassDef(StSPtrVecEpdHit,1) 
};
typedef       StEpdHitIterator  StPtrVecEpdHitIterator;
typedef const_StEpdHitIterator  StPtrVecEpdHitConstIterator;
typedef       StEpdHitIterator  StSPtrVecEpdHitIterator;
typedef const_StEpdHitIterator  StSPtrVecEpdHitConstIterator;
...
//______________________________________________________________
class StFcsCluster;
typedef StFcsCluster**            StFcsClusterIterator;
typedef StFcsCluster * const * const_StFcsClusterIterator;

class StPtrVecFcsCluster : public StRefArray 
{ 
public: 
StPtrVecFcsCluster(Int_t sz=0):StRefArray(sz){};
StPtrVecFcsCluster(const StPtrVecFcsCluster &from):StRefArray(from){};
virtual        ~StPtrVecFcsCluster(){};

 StFcsCluster * const &at(Int_t idx) const {return (StFcsCluster  * const &)fV[idx];}
 StFcsCluster *       &at(Int_t idx)       {return (StFcsCluster  *       &)fV[idx];}

 StFcsCluster * const &front()       const {return (StFcsCluster  * const &)fV.front();}
 StFcsCluster *       &front()             {return (StFcsCluster  *       &)fV.front();}

 StFcsCluster * const &back()        const {return (StFcsCluster  * const &)fV.back();}
 StFcsCluster *       &back()              {return (StFcsCluster  *       &)fV.back();}

const_StFcsClusterIterator begin() const {return (const_StFcsClusterIterator)&(*(fV.begin()));}
      StFcsClusterIterator begin()       {return (      StFcsClusterIterator)&(*(fV.begin()));}
const_StFcsClusterIterator end()   const {return (const_StFcsClusterIterator)&(*(fV.end()));}
      StFcsClusterIterator end()         {return (      StFcsClusterIterator)&(*(fV.end()));}
      StFcsClusterIterator erase(StFcsClusterIterator  it)
      {return (StFcsClusterIterator)Erase((TObject**)it,0);}
      StFcsClusterIterator erase(StFcsClusterIterator fst,StFcsClusterIterator lst)
      {return (StFcsClusterIterator)Erase((TObject**)fst,(TObject**)lst,0);}
      StFcsCluster *       &operator[](Int_t i)       {return at(i);}
      StFcsCluster * const &operator[](Int_t i) const {return at(i);}
void  push_back(const StFcsCluster * const to){fV.push_back((TObject*const)to);}

ClassDef(StPtrVecFcsCluster ,1) 
};


class StSPtrVecFcsCluster : public StStrArray 
{ 
public: 
StSPtrVecFcsCluster(Int_t sz=0):StStrArray(sz){};
StSPtrVecFcsCluster(const StSPtrVecFcsCluster &from):StStrArray(from){};
...
const_StFcsClusterIterator end()   const {return (const_StFcsClusterIterator)&(*(fV.end()));}
      StFcsClusterIterator end()         {return (      StFcsClusterIterator)&(*(fV.end()));}
      StFcsClusterIterator erase(StFcsClusterIterator  it)
      {return (StFcsClusterIterator)Erase((TObject**)it,1);}
      StFcsClusterIterator erase(StFcsClusterIterator fst,StFcsClusterIterator lst)
      {return (StFcsClusterIterator)Erase((TObject**)fst,(TObject**)lst,1);}
      StFcsCluster *       &operator[](Int_t i)       {return at(i);}
      StFcsCluster * const &operator[](Int_t i) const {return at(i);}
void  push_back(const StFcsCluster *to){StStrArray::push_back((TObject*)to);}

ClassDef(StSPtrVecFcsCluster,1) 
};
typedef       StFcsClusterIterator  StPtrVecFcsClusterIterator;
typedef const_StFcsClusterIterator  StPtrVecFcsClusterConstIterator;
typedef       StFcsClusterIterator  StSPtrVecFcsClusterIterator;
typedef const_StFcsClusterIterator  StSPtrVecFcsClusterConstIterator;

//______________________________________________________________
class StFcsHit;
typedef StFcsHit**            StFcsHitIterator;
typedef StFcsHit * const * const_StFcsHitIterator;

class StPtrVecFcsHit : public StRefArray 
{ 
public: 
StPtrVecFcsHit(Int_t sz=0):StRefArray(sz){};
StPtrVecFcsHit(const StPtrVecFcsHit &from):StRefArray(from){};
virtual        ~StPtrVecFcsHit(){};

 StFcsHit * const &at(Int_t idx) const {return (StFcsHit  * const &)fV[idx];}
 StFcsHit *       &at(Int_t idx)       {return (StFcsHit  *       &)fV[idx];}

 StFcsHit * const &front()       const {return (StFcsHit  * const &)fV.front();}
 StFcsHit *       &front()             {return (StFcsHit  *       &)fV.front();}

 StFcsHit * const &back()        const {return (StFcsHit  * const &)fV.back();}
 StFcsHit *       &back()              {return (StFcsHit  *       &)fV.back();}

const_StFcsHitIterator begin() const {return (const_StFcsHitIterator)&(*(fV.begin()));}
      StFcsHitIterator begin()       {return (      StFcsHitIterator)&(*(fV.begin()));}
const_StFcsHitIterator end()   const {return (const_StFcsHitIterator)&(*(fV.end()));}
      StFcsHitIterator end()         {return (      StFcsHitIterator)&(*(fV.end()));}
      StFcsHitIterator erase(StFcsHitIterator  it)
      {return (StFcsHitIterator)Erase((TObject**)it,0);}
      StFcsHitIterator erase(StFcsHitIterator fst,StFcsHitIterator lst)
      {return (StFcsHitIterator)Erase((TObject**)fst,(TObject**)lst,0);}
      StFcsHit *       &operator[](Int_t i)       {return at(i);}
      StFcsHit * const &operator[](Int_t i) const {return at(i);}
void  push_back(const StFcsHit * const to){fV.push_back((TObject*const)to);}

ClassDef(StPtrVecFcsHit ,1) 
};


class StSPtrVecFcsHit : public StStrArray 
{ 
public: 
StSPtrVecFcsHit(Int_t sz=0):StStrArray(sz){};
StSPtrVecFcsHit(const StSPtrVecFcsHit &from):StStrArray(from){};
...
const_StFcsHitIterator end()   const {return (const_StFcsHitIterator)&(*(fV.end()));}
      StFcsHitIterator end()         {return (      StFcsHitIterator)&(*(fV.end()));}
      StFcsHitIterator erase(StFcsHitIterator  it)
      {return (StFcsHitIterator)Erase((TObject**)it,1);}
      StFcsHitIterator erase(StFcsHitIterator fst,StFcsHitIterator lst)
      {return (StFcsHitIterator)Erase((TObject**)fst,(TObject**)lst,1);}
      StFcsHit *       &operator[](Int_t i)       {return at(i);}
      StFcsHit * const &operator[](Int_t i) const {return at(i);}
void  push_back(const StFcsHit *to){StStrArray::push_back((TObject*)to);}

ClassDef(StSPtrVecFcsHit,1) 
};
typedef       StFcsHitIterator  StPtrVecFcsHitIterator;
typedef const_StFcsHitIterator  StPtrVecFcsHitConstIterator;
typedef       StFcsHitIterator  StSPtrVecFcsHitIterator;
typedef const_StFcsHitIterator  StSPtrVecFcsHitConstIterator;

//______________________________________________________________
class StFcsPoint;
typedef StFcsPoint**            StFcsPointIterator;
typedef StFcsPoint * const * const_StFcsPointIterator;

class StPtrVecFcsPoint : public StRefArray 
{ 
public: 
StPtrVecFcsPoint(Int_t sz=0):StRefArray(sz){};
StPtrVecFcsPoint(const StPtrVecFcsPoint &from):StRefArray(from){};
virtual        ~StPtrVecFcsPoint(){};

 StFcsPoint * const &at(Int_t idx) const {return (StFcsPoint  * const &)fV[idx];}
 StFcsPoint *       &at(Int_t idx)       {return (StFcsPoint  *       &)fV[idx];}

 StFcsPoint * const &front()       const {return (StFcsPoint  * const &)fV.front();}
 StFcsPoint *       &front()             {return (StFcsPoint  *       &)fV.front();}

 StFcsPoint * const &back()        const {return (StFcsPoint  * const &)fV.back();}
 StFcsPoint *       &back()              {return (StFcsPoint  *       &)fV.back();}

const_StFcsPointIterator begin() const {return (const_StFcsPointIterator)&(*(fV.begin()));}
      StFcsPointIterator begin()       {return (      StFcsPointIterator)&(*(fV.begin()));}
const_StFcsPointIterator end()   const {return (const_StFcsPointIterator)&(*(fV.end()));}
      StFcsPointIterator end()         {return (      StFcsPointIterator)&(*(fV.end()));}
      StFcsPointIterator erase(StFcsPointIterator  it)
      {return (StFcsPointIterator)Erase((TObject**)it,0);}
      StFcsPointIterator erase(StFcsPointIterator fst,StFcsPointIterator lst)
      {return (StFcsPointIterator)Erase((TObject**)fst,(TObject**)lst,0);}
      StFcsPoint *       &operator[](Int_t i)       {return at(i);}
      StFcsPoint * const &operator[](Int_t i) const {return at(i);}
void  push_back(const StFcsPoint * const to){fV.push_back((TObject*const)to);}

ClassDef(StPtrVecFcsPoint ,1) 
};


class StSPtrVecFcsPoint : public StStrArray 
{ 
public: 
StSPtrVecFcsPoint(Int_t sz=0):StStrArray(sz){};
StSPtrVecFcsPoint(const StSPtrVecFcsPoint &from):StStrArray(from){};
...
const_StFcsPointIterator end()   const {return (const_StFcsPointIterator)&(*(fV.end()));}
      StFcsPointIterator end()         {return (      StFcsPointIterator)&(*(fV.end()));}
      StFcsPointIterator erase(StFcsPointIterator  it)
      {return (StFcsPointIterator)Erase((TObject**)it,1);}
      StFcsPointIterator erase(StFcsPointIterator fst,StFcsPointIterator lst)
      {return (StFcsPointIterator)Erase((TObject**)fst,(TObject**)lst,1);}
      StFcsPoint *       &operator[](Int_t i)       {return at(i);}
      StFcsPoint * const &operator[](Int_t i) const {return at(i);}
void  push_back(const StFcsPoint *to){StStrArray::push_back((TObject*)to);}

ClassDef(StSPtrVecFcsPoint,1) 
};
typedef       StFcsPointIterator  StPtrVecFcsPointIterator;
typedef const_StFcsPointIterator  StPtrVecFcsPointConstIterator;
typedef       StFcsPointIterator  StSPtrVecFcsPointIterator;
typedef const_StFcsPointIterator  StSPtrVecFcsPointConstIterator;
...
//______________________________________________________________
class StETofHit;
typedef StETofHit**            StETofHitIterator;
typedef StETofHit * const * const_StETofHitIterator;

class StPtrVecETofHit : public StRefArray 
{ 
public: 
StPtrVecETofHit(Int_t sz=0):StRefArray(sz){};
StPtrVecETofHit(const StPtrVecETofHit &from):StRefArray(from){};
virtual        ~StPtrVecETofHit(){};

 StETofHit * const &at(Int_t idx) const {return (StETofHit  * const &)fV[idx];}
 StETofHit *       &at(Int_t idx)       {return (StETofHit  *       &)fV[idx];}

 StETofHit * const &front()       const {return (StETofHit  * const &)fV.front();}
 StETofHit *       &front()             {return (StETofHit  *       &)fV.front();}

 StETofHit * const &back()        const {return (StETofHit  * const &)fV.back();}
 StETofHit *       &back()              {return (StETofHit  *       &)fV.back();}

const_StETofHitIterator begin() const {return (const_StETofHitIterator)&(*(fV.begin()));}
      StETofHitIterator begin()       {return (      StETofHitIterator)&(*(fV.begin()));}
const_StETofHitIterator end()   const {return (const_StETofHitIterator)&(*(fV.end()));}
      StETofHitIterator end()         {return (      StETofHitIterator)&(*(fV.end()));}
      StETofHitIterator erase(StETofHitIterator  it)
      {return (StETofHitIterator)Erase((TObject**)it,0);}
      StETofHitIterator erase(StETofHitIterator fst,StETofHitIterator lst)
      {return (StETofHitIterator)Erase((TObject**)fst,(TObject**)lst,0);}
      StETofHit *       &operator[](Int_t i)       {return at(i);}
      StETofHit * const &operator[](Int_t i) const {return at(i);}
void  push_back(const StETofHit * const to){fV.push_back((TObject*const)to);}

ClassDef(StPtrVecETofHit ,1) 
};


class StSPtrVecETofHit : public StStrArray 
{ 
public: 
StSPtrVecETofHit(Int_t sz=0):StStrArray(sz){};
StSPtrVecETofHit(const StSPtrVecETofHit &from):StStrArray(from){};
...
const_StETofHitIterator end()   const {return (const_StETofHitIterator)&(*(fV.end()));}
      StETofHitIterator end()         {return (      StETofHitIterator)&(*(fV.end()));}
      StETofHitIterator erase(StETofHitIterator  it)
      {return (StETofHitIterator)Erase((TObject**)it,1);}
      StETofHitIterator erase(StETofHitIterator fst,StETofHitIterator lst)
      {return (StETofHitIterator)Erase((TObject**)fst,(TObject**)lst,1);}
      StETofHit *       &operator[](Int_t i)       {return at(i);}
      StETofHit * const &operator[](Int_t i) const {return at(i);}
void  push_back(const StETofHit *to){StStrArray::push_back((TObject*)to);}

ClassDef(StSPtrVecETofHit,1) 
};
typedef       StETofHitIterator  StPtrVecETofHitIterator;
typedef const_StETofHitIterator  StPtrVecETofHitConstIterator;
typedef       StETofHitIterator  StSPtrVecETofHitIterator;
typedef const_StETofHitIterator  StSPtrVecETofHitConstIterator;

//______________________________________________________________
class StETofDigi;
typedef StETofDigi**            StETofDigiIterator;
typedef StETofDigi * const * const_StETofDigiIterator;

class StPtrVecETofDigi : public StRefArray 
{ 
public: 
StPtrVecETofDigi(Int_t sz=0):StRefArray(sz){};
StPtrVecETofDigi(const StPtrVecETofDigi &from):StRefArray(from){};
virtual        ~StPtrVecETofDigi(){};

 StETofDigi * const &at(Int_t idx) const {return (StETofDigi  * const &)fV[idx];}
 StETofDigi *       &at(Int_t idx)       {return (StETofDigi  *       &)fV[idx];}

 StETofDigi * const &front()       const {return (StETofDigi  * const &)fV.front();}
 StETofDigi *       &front()             {return (StETofDigi  *       &)fV.front();}

 StETofDigi * const &back()        const {return (StETofDigi  * const &)fV.back();}
 StETofDigi *       &back()              {return (StETofDigi  *       &)fV.back();}

const_StETofDigiIterator begin() const {return (const_StETofDigiIterator)&(*(fV.begin()));}
      StETofDigiIterator begin()       {return (      StETofDigiIterator)&(*(fV.begin()));}
const_StETofDigiIterator end()   const {return (const_StETofDigiIterator)&(*(fV.end()));}
      StETofDigiIterator end()         {return (      StETofDigiIterator)&(*(fV.end()));}
      StETofDigiIterator erase(StETofDigiIterator  it)
      {return (StETofDigiIterator)Erase((TObject**)it,0);}
      StETofDigiIterator erase(StETofDigiIterator fst,StETofDigiIterator lst)
      {return (StETofDigiIterator)Erase((TObject**)fst,(TObject**)lst,0);}
      StETofDigi *       &operator[](Int_t i)       {return at(i);}
      StETofDigi * const &operator[](Int_t i) const {return at(i);}
void  push_back(const StETofDigi * const to){fV.push_back((TObject*const)to);}

ClassDef(StPtrVecETofDigi ,1) 
};


class StSPtrVecETofDigi : public StStrArray 
{ 
public: 
StSPtrVecETofDigi(Int_t sz=0):StStrArray(sz){};
StSPtrVecETofDigi(const StSPtrVecETofDigi &from):StStrArray(from){};
...
const_StETofDigiIterator end()   const {return (const_StETofDigiIterator)&(*(fV.end()));}
      StETofDigiIterator end()         {return (      StETofDigiIterator)&(*(fV.end()));}
      StETofDigiIterator erase(StETofDigiIterator  it)
      {return (StETofDigiIterator)Erase((TObject**)it,1);}
      StETofDigiIterator erase(StETofDigiIterator fst,StETofDigiIterator lst)
      {return (StETofDigiIterator)Erase((TObject**)fst,(TObject**)lst,1);}
      StETofDigi *       &operator[](Int_t i)       {return at(i);}
      StETofDigi * const &operator[](Int_t i) const {return at(i);}
void  push_back(const StETofDigi *to){StStrArray::push_back((TObject*)to);}

ClassDef(StSPtrVecETofDigi,1) 
};
typedef       StETofDigiIterator  StPtrVecETofDigiIterator;
typedef const_StETofDigiIterator  StPtrVecETofDigiConstIterator;
typedef       StETofDigiIterator  StSPtrVecETofDigiIterator;
typedef const_StETofDigiIterator  StSPtrVecETofDigiConstIterator;
