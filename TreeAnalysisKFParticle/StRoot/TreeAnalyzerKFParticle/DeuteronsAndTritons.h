...
class DeuteronsAndTritons
{
    private:
        ...
        Double_t zDeuteron;
        Double_t zTriton;
        Bool_t FoundWithDeuteronTPC;
        Bool_t FoundWithDeuteronToF;
        Bool_t FoundWithDeuteronEToF;
        Bool_t FoundWithTritonTPC;
        Bool_t FoundWithTritonToF;
        Bool_t FoundWithTritonEToF;

    public:
        DeuteronsAndTritons();
        DeuteronsAndTritons(Double_t p, Double_t dEdx, Double_t tofBeta, Double_t EToFBeta, Double_t zDeuteron, Double_t zTriton, Bool_t FoundWithDeuteronTPC, Bool_t FoundWithDeuteronToF, Bool_t FoundWithDeuteronEToF, Bool_t FoundWithTritonTPC, Bool_t FoundWithTritonToF, Bool_t FoundWithTritonEToF);

        Bool_t GetFoundWithDeuteronTPC();
        Bool_t GetFoundWithDeuteronToF();
        Bool_t GetFoundWithDeuteronEToF();
        Bool_t GetFoundWithTritonTPC();
        Bool_t GetFoundWithTritonToF();
        Bool_t GetFoundWithTritonEToF();
        Bool_t IsDeuteron();
        Bool_t IsTriton();
...
DeuteronsAndTritons::DeuteronsAndTritons()
{
    ...
    this->zDeuteron = 0;
    this->zTriton = 0;
    this->FoundWithDeuteronTPC = false;
    this->FoundWithDeuteronToF = false;
    this->FoundWithDeuteronEToF = false;
    this->FoundWithTritonTPC = false;
    this->FoundWithTritonToF = false;
    this->FoundWithTritonEToF = false;
}

DeuteronsAndTritons::DeuteronsAndTritons(Double_t p, Double_t dEdx, Double_t tofBeta, Double_t EToFBeta, Double_t zDeuteron, Double_t zTriton, Bool_t FoundWithDeuteronTPC, Bool_t FoundWithDeuteronToF, Bool_t FoundWithDeuteronEToF, Bool_t FoundWithTritonTPC, Bool_t FoundWithTritonToF, Bool_t FoundWithTritonEToF)
{
    this->p = p;
    this->dEdx = dEdx;
    this->tofBeta = tofBeta;
    this->EToFBeta = EToFBeta;
    this->zDeuteron = zDeuteron;
    this->zTriton = zTriton;
    this->FoundWithDeuteronTPC = FoundWithDeuteronTPC;
    this->FoundWithDeuteronToF = FoundWithDeuteronToF;
    this->FoundWithDeuteronEToF = FoundWithDeuteronEToF;
    this->FoundWithTritonTPC = FoundWithTritonTPC;
    this->FoundWithTritonToF = FoundWithTritonToF;
    this->FoundWithTritonEToF = FoundWithTritonEToF;
}
...
Bool_t DeuteronsAndTritons::IsDeuteron()
{
    ...
    if (momentum >= 0.4 && momentum < 3.0)
    {
        ...
        if(deuteron)
        {
            this->FoundWithDeuteronTPC = true;
        }
    }
    ...
    if(this->EToFBeta > 0)
    {
        Double_t msquared = (pow(momentum,2) * ((1/pow(this->EToFBeta,2)) - 1));

        if (zDeuteron > zLow && zDeuteron < zHigh && msquared > msquaredLow && msquared < msquaredHigh)
        {
            deuteron = true;

            this->FoundWithDeuteronEToF = true;
        }
    }
...
Bool_t DeuteronsAndTritons::GetFoundWithDeuteronTPC()
{
    return this->FoundWithDeuteronTPC;
}
...
Bool_t DeuteronsAndTritons::GetFoundWithDeuteronEToF()
{
    return this->FoundWithDeuteronEToF;
}
...
Bool_t DeuteronsAndTritons::GetFoundWithTritonTPC()
{
    return this->FoundWithTritonTPC;
}
...
Bool_t DeuteronsAndTritons::GetFoundWithTritonEToF()
{
    return this->FoundWithTritonEToF;
}
