...
void calculateSystematicsAlternate(TString order_n_str = "3")
{
  ...
  Variation* Normal = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/4-30-24-V2-HistogramNormal.root ", order_n_str);
...
//   Variation* m2Ka_low_20  = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassMSquaredKaon20Low.root", order_n_str);
  ...
  Variation* nSigPi_high_30 = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/4-30-24-V2-HistogramNSigmaPion1.root", order_n_str);
  Variation* nSigPi_low_30  = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/4-30-24-V2-HistogramNSigmaPion2.root", order_n_str);
  Variation* nSigKa_high_30 = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/4-30-24-V2-HistogramNSigmaKaon1.root", order_n_str);
  Variation* nSigKa_low_30  = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/4-30-24-V2-HistogramNSigmaKaon2.root", order_n_str);
  ...
  Variation* nSigPr_high_30 = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/4-30-24-V2-HistogramNSigmaProton1.root", order_n_str);
  Variation* nSigPr_low_30  = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/4-30-24-V2-HistogramNSigmaProton2.root", order_n_str);
...
//   Variation* zvtx_low_30  = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassZVertex30Low.root", order_n_str);
  Variation* dca_high_30 = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/4-30-24-V2-HistogramDCA1.root", order_n_str);
  Variation* dca_low_30  = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/4-30-24-V2-HistogramDCA2.root", order_n_str);
  Variation* nhits_high_30 = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/4-30-24-V2-HistogramNHits1.root ", order_n_str);
  Variation* nhits_low_30 = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/4-30-24-V2-HistogramNHits2.root ", order_n_str);
...
//   Variation* nhitsratio_low_30  = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V3Histograms/3-25-24-V3-HistogramNHitsFitOverNHitsPoss20Low.root", order_n_str);
  Variation* m2Pi_high_30 = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/4-30-24-V2-HistogramMSquaredPion.root", order_n_str);
//   Variation* m2Pi_low_30  = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassMSquaredPion30Low.root", order_n_str);
  Variation* m2Ka_high_30 = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/4-30-24-V2-HistogramMSquaredKaon.root", order_n_str);
//   Variation* m2Ka_low_30  = new Variation("/star/u/mcgordon/SystematicsCameronResolution/HistogramFourthPassMSquaredKaon30Low.root", order_n_str);
  Variation* m2Pr_high_30 = new Variation("/star/data01/pwg/mcgordon/VnFromEPD/V2Histograms/4-30-24-V2-HistogramMSquaredProton.root", order_n_str);
