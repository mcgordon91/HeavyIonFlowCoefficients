...
//     Int_t NHitsdEdxBound = 5;
    ...
    Double_t DeuteronUpperPt = 1.6;
    Double_t TritonLowerPt = 1.2;
    Double_t TritonUpperPt = 2.4;
...
//     }
    ...
    TFile *TPCEfficiencyFileLiteratureProton; // Disappearance Paper
    TFile *TPCEfficiencyFileLiteratureKaonPlus;
    TFile *TPCEfficiencyFileLiteratureKaonMinus;
    TFile *ToFEfficiencyFileLiterature; // Disappearance Paper
    TFile *EfficiencyFileLiteratureDandT; // Light Nuclei Paper
    TFile *CentralityWeightFile; // Light Nuclei Paper
    ...
    if(RunIteration == 2)
    {
        std::string QVectorHistogramFirstString = "/star/data01/pwg/mcgordon/VnFromEPD/V" + std::to_string(1) + "Histograms/QVectorFirstPass" + argv[3] + ".root";
    ...
    if(RunIteration == 3)
    {
        ...
        std::string QVectorHistogramSecondString = "/star/data01/pwg/mcgordon/VnFromEPD/V" + std::to_string(1) + "Histograms/QVectorSecondPass" + argv[3] + ".root";
    ...
    if(RunIteration == 4)
    {
        ...
        std::string ResolutionFileString = "/star/data01/pwg/mcgordon/VnFromEPD/V" + std::to_string(nV) + "Histograms/R_" + std::to_string(nV) + std::to_string(nPsi) + "_" + argv[3] + "NewDataset.root";
...
//     TritonTrackLabels = ["IDed as Any Particle", "IDed as a t", "IDed as a Good t"]     
    ...
    TH1D *EventCheck = new TH1D("h_eventCheck","Event number after each cut;;Events", 8, 0, 8);
...
//         TritonTrackCheck.GetXaxis().SetBinLabel(i, TritonTrackLabels[i - 1])
    ...
    TProfile2D *HistoD79 = new TProfile2D("DataVnCorrectedVsPtDifferentCentralitiesProton", D79Char, NumberOfCentralityBins, CentralityBinEdges, 20, 0, 2);
    HistoD79->Sumw2();
    ...
    TProfile2D *HistoD80 = new TProfile2D("DataVnCorrectedVsYDifferentCentralitiesProton", D80Char, NumberOfCentralityBins, CentralityBinEdges, 10, 0, 1);
    HistoD80->Sumw2();
    ...
    TProfile2D *HistoD81 = new TProfile2D("DataVnCorrectedVsPtDifferentCentralitiesKaonPlus", D81Char, NumberOfCentralityBins, CentralityBinEdges, 20, 0, 2);
    HistoD81->Sumw2();
    ...
    TProfile2D *HistoD82 = new TProfile2D("DataVnCorrectedVsYDifferentCentralitiesKaonPlus", D82Char, NumberOfCentralityBins, CentralityBinEdges, 10, 0, 1);
    HistoD82->Sumw2();
    ...
    TProfile2D *HistoD83 = new TProfile2D("DataVnCorrectedVsPtDifferentCentralitiesKaonMinus", D83Char, NumberOfCentralityBins, CentralityBinEdges, 20, 0, 2);
    HistoD83->Sumw2();
    ...
    TProfile2D *HistoD84 = new TProfile2D("DataVnCorrectedVsYDifferentCentralitiesKaonMinus", D84Char, NumberOfCentralityBins, CentralityBinEdges, 10, 0, 1);
    HistoD84->Sumw2();
    ...
    TProfile2D *HistoD85 = new TProfile2D("DataVnCorrectedVsPtDifferentCentralitiesPionPlus", D85Char, NumberOfCentralityBins, CentralityBinEdges, 20, 0, 2);
    HistoD85->Sumw2();
    ...
    TProfile2D *HistoD86 = new TProfile2D("DataVnCorrectedVsYDifferentCentralitiesPionPlus", D86Char, NumberOfCentralityBins, CentralityBinEdges, 10, 0, 1);
    HistoD86->Sumw2();
    ...
    TProfile2D *HistoD87 = new TProfile2D("DataVnCorrectedVsPtDifferentCentralitiesPionMinus", D87Char, NumberOfCentralityBins, CentralityBinEdges, 20, 0, 2);
    HistoD87->Sumw2();
    ...
    TProfile2D *HistoD88 = new TProfile2D("DataVnCorrectedVsYDifferentCentralitiesPionMinus", D88Char, NumberOfCentralityBins, CentralityBinEdges, 10, 0, 1);
    HistoD88->Sumw2();
    ...
    TProfile2D *HistoD88A = new TProfile2D("DataVnCorrectedVsPtDifferentCentralitiesDeuterons", D88AChar, NumberOfCentralityBins, CentralityBinEdges, 20, 0, 2);
    HistoD88A->Sumw2();
    ...
    TProfile2D *HistoD88B = new TProfile2D("DataVnCorrectedVsYDifferentCentralitiesDeuterons", D88BChar, NumberOfCentralityBins, CentralityBinEdges, 10, 0, 1);
    HistoD88B->Sumw2();
    ...
    TProfile2D *HistoD88C = new TProfile2D("DataVnCorrectedVsPtDifferentCentralitiesTritons", D88CChar, NumberOfCentralityBins, CentralityBinEdges, 20, 0, 2);
    HistoD88C->Sumw2();
    ...
    TProfile2D *HistoD88D = new TProfile2D("DataVnCorrectedVsYDifferentCentralitiesTritons", D88DChar, NumberOfCentralityBins, CentralityBinEdges, 10, 0, 1);
    HistoD88D->Sumw2();
    ...
    TProfile2D *VnVsYSymmetricProton = new TProfile2D("DataVnCorrectedVsYSymmetricDifferentCentralitiesProtons", VnVsYSymmetricProtonChar, NumberOfCentralityBins, CentralityBinEdges, 10, -0.5, 0.5);
    ...
    TProfile *VnVsPtProton0_00Through0_10 = new TProfile("VnVsPtProton0_00Through0_10", VnVsPtProton0_00Through0_10Char, 20, 0, 2);
    ...
    TProfile *VnVsPtProton0_10Through0_20 = new TProfile("VnVsPtProton0_10Through0_20", VnVsPtProton0_10Through0_20Char, 20, 0, 2);
    ...
    TProfile *VnVsPtProton0_20Through0_30 = new TProfile("VnVsPtProton0_20Through0_30", VnVsPtProton0_20Through0_30Char, 20, 0, 2);
    ...
    TProfile *VnVsPtProton0_30Through0_40 = new TProfile("VnVsPtProton0_30Through0_40", VnVsPtProton0_30Through0_40Char, 20, 0, 2);
    ...
    TProfile *VnVsPtDeuteron0_00Through0_10 = new TProfile("VnVsPtDeuteron0_00Through0_10", VnVsPtDeuteron0_00Through0_10Char, 20, 0, 2);
    ...
    TProfile *VnVsPtDeuteron0_10Through0_20 = new TProfile("VnVsPtDeuteron0_10Through0_20", VnVsPtDeuteron0_10Through0_20Char, 20, 0, 2);
    ...
    TProfile *VnVsPtDeuteron0_20Through0_30 = new TProfile("VnVsPtDeuteron0_20Through0_30", VnVsPtDeuteron0_20Through0_30Char, 20, 0, 2);
    ...
    TProfile *VnVsPtDeuteron0_30Through0_40 = new TProfile("VnVsPtDeuteron0_30Through0_40", VnVsPtDeuteron0_30Through0_40Char, 20, 0, 2);
    ...
    TProfile *VnVsPtTriton0_00Through0_10 = new TProfile("VnVsPtTriton0_00Through0_10", VnVsPtTriton0_00Through0_10Char, 20, 0, 2);
    ...
    TProfile *VnVsPtTriton0_10Through0_20 = new TProfile("VnVsPtTriton0_10Through0_20", VnVsPtTriton0_10Through0_20Char, 20, 0, 2);
    ...
    TProfile *VnVsPtTriton0_20Through0_30 = new TProfile("VnVsPtTriton0_20Through0_30", VnVsPtTriton0_20Through0_30Char, 20, 0, 2);
    ...
    TProfile *VnVsPtTriton0_30Through0_40 = new TProfile("VnVsPtTriton0_30Through0_40", VnVsPtTriton0_30Through0_40Char, 20, 0, 2);
    ...
    TProfile *VnOverAVsPtOverAProton0_00Through0_10 = new TProfile("VnOverAVsPtOverAProton0_00Through0_10", VnOverAVsPtOverAProton0_00Through0_10Char, 20, 0, 2);
    ...
    TProfile *VnOverAVsPtOverAProton0_10Through0_20 = new TProfile("VnOverAVsPtOverAProton0_10Through0_20", VnOverAVsPtOverAProton0_10Through0_20Char, 20, 0, 2);
    ...
    TProfile *VnOverAVsPtOverAProton0_20Through0_30 = new TProfile("VnOverAVsPtOverAProton0_20Through0_30", VnOverAVsPtOverAProton0_20Through0_30Char, 20, 0, 2);
    ...
    TProfile *VnOverAVsPtOverAProton0_30Through0_40 = new TProfile("VnOverAVsPtOverAProton0_30Through0_40", VnOverAVsPtOverAProton0_30Through0_40Char, 20, 0, 2);
    ...
    TProfile *VnOverAVsPtOverADeuteron0_00Through0_10 = new TProfile("VnOverAVsPtOverADeuteron0_00Through0_10", VnOverAVsPtOverADeuteron0_00Through0_10Char, 20, 0, 2);
    ...
    TProfile *VnOverAVsPtOverADeuteron0_10Through0_20 = new TProfile("VnOverAVsPtOverADeuteron0_10Through0_20", VnOverAVsPtOverADeuteron0_10Through0_20Char, 20, 0, 2);
    ...
    TProfile *VnOverAVsPtOverADeuteron0_20Through0_30 = new TProfile("VnOverAVsPtOverADeuteron0_20Through0_30", VnOverAVsPtOverADeuteron0_20Through0_30Char, 20, 0, 2);
    ...
    TProfile *VnOverAVsPtOverADeuteron0_30Through0_40 = new TProfile("VnOverAVsPtOverADeuteron0_30Through0_40", VnOverAVsPtOverADeuteron0_30Through0_40Char, 20, 0, 2);
    ...
    TProfile *VnOverAVsPtOverATriton0_00Through0_10 = new TProfile("VnOverAVsPtOverATriton0_00Through0_10", VnOverAVsPtOverATriton0_00Through0_10Char, 20, 0, 2);
    ...
    TProfile *VnOverAVsPtOverATriton0_10Through0_20 = new TProfile("VnOverAVsPtOverATriton0_10Through0_20", VnOverAVsPtOverATriton0_10Through0_20Char, 20, 0, 2);
    ...
    TProfile *VnOverAVsPtOverATriton0_20Through0_30 = new TProfile("VnOverAVsPtOverATriton0_20Through0_30", VnOverAVsPtOverATriton0_20Through0_30Char, 20, 0, 2);
    ...
    TProfile *VnOverAVsPtOverATriton0_30Through0_40 = new TProfile("VnOverAVsPtOverATriton0_30Through0_40", VnOverAVsPtOverATriton0_30Through0_40Char, 20, 0, 2);
    ...
    // Event Loop
    for (Long64_t EventNum = 0; AutreeData->GetEntries(); EventNum++)
    {
        if (RunIteration == 1)
        {
            if (EventNum % 5000 == 0)
...
//                     Double_t TPCEfficiency = TPCEfficiencyHistogram->GetBinContent(TPCEfficiencyBinX, TPCEfficiencyBinY);
                    ...
                    TH2D *TrackingEfficiencyHistogram = (TH2D*)EfficiencyFileLiteratureDandT->Get("tracking_d");
                    TH1D *TPCEfficiencyHistogram = (TH1D*)EfficiencyFileLiteratureDandT->Get("tpc_d");
                    TH1D *ToFEfficiencyHistogram = (TH1D*)EfficiencyFileLiteratureDandT->Get("tof_d");
                    TH2D *ToFMatchHistogram = (TH2D*)EfficiencyFileLiteratureDandT->Get("tofmatch");
                    ...
                    Efficiency = Efficiency * (Float_t)TrackingEfficiencyHistogram->GetBinContent(TrackingEfficiencyHistogram->FindBin(y - yCMShift, pt));
                    
                    if(p < 3.2)
                    {
                        Efficiency = Efficiency * (Float_t)TPCEfficiencyHistogram->GetBinContent(TPCEfficiencyHistogram->FindBin(p));
                    }
                    
                    else if(p > 3.2)
                    {
                        Efficiency = Efficiency * (Float_t)ToFEfficiencyHistogram->GetBinContent(ToFEfficiencyHistogram->FindBin(p));
                        Efficiency = Efficiency*(Float_t)ToFMatchHistogram->GetBinContent(ToFMatchHistogram->FindBin(eta, pt));
                    }
...
//                     Double_t TPCEfficiency = TPCEfficiencyHistogram->GetBinContent(TPCEfficiencyBinX, TPCEfficiencyBinY);
                    ...
                    TH2D *TrackingEfficiencyHistogram = (TH2D*)EfficiencyFileLiteratureDandT->Get("tracking_t");
                    TH1D *TPCEfficiencyHistogram = (TH1D*)EfficiencyFileLiteratureDandT->Get("tpc_t");
                    TH1D *ToFEfficiencyHistogram = (TH1D*)EfficiencyFileLiteratureDandT->Get("tof_t");
                    TH2D *ToFMatchHistogram = (TH2D*)EfficiencyFileLiteratureDandT->Get("tofmatch");
                    TH1D *m_hreweight = (TH1D*)CentralityWeightFile->Get("Ratioglaubertodata");
...
//                         }
    ...
    if(RunIteration == 4)
    {
        ...
        TPCEfficiencyFileLiteratureProton->Close();
        TPCEfficiencyFileLiteratureKaonPlus->Close();
        TPCEfficiencyFileLiteratureKaonMinus->Close();
        ToFEfficiencyFileLiterature->Close();
        EfficiencyFileLiteratureDandT->Close();
