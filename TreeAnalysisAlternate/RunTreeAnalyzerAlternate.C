...
void RunTreeAnalyzerAlternate(const Char_t *InputFile,  Char_t *JobID, const Char_t *Systematic)
{
    ...
    gSystem->Load("TreeAnalyzerAlternate.so");
    ...
    TreeAnalyzerAlternate *Analyzer = new TreeAnalyzerAlternate(picoMaker, JobID, Systematic);
