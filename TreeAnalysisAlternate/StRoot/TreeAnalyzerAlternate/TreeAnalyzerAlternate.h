#ifndef TreeAnalyzerAlternate_def
#define TreeAnalyzerAlternate_def
...
class TreeAnalyzerAlternate : public StMaker 
{

    public:
        TreeAnalyzerAlternate(StPicoDstMaker *picoMaker, Char_t *JobID, Char_t *Systematic);   // constructor
        virtual ~TreeAnalyzerAlternate(){}                                 // destructor
    ...
    private:
        ...
        const Int_t FourierCorrectionTerms = 20;
        ...
        TFile *EfficiencyFileLiteratureDandT; // Light Nuclei Paper, has TPC, ToF, and Tracking efficiencies
...
ClassDef(TreeAnalyzerAlternate,1)
};
#endif
