...
void CompositeData::initialize()
{
  ...
  barlow_vn_de = new TH1D("barlow_vn_de_"+ID, "pr vs cent;Centrality;#Delta/#sigma_{#Delta}", 12, 0, 60);
  barlow_vn_tr = new TH1D("barlow_vn_tr_"+ID, "pr vs cent;Centrality;#Delta/#sigma_{#Delta}", 12, 0, 60);
  ...
  barlow_vn_yCM_00to10_de = new TH1D("barlow_vn_yCM_00to10_de_"+ID, "0-10% de vs yCM;y-y_{mid};#Delta/#sigma_{#Delta}", 20, -1, 1);
  barlow_vn_yCM_10to40_de = new TH1D("barlow_vn_yCM_10to40_de_"+ID, "10-40% de vs yCM;y-y_{mid};#Delta/#sigma_{#Delta}", 20, -1, 1);
  barlow_vn_yCM_40to60_de = new TH1D("barlow_vn_yCM_40to60_de_"+ID, "40-60% de vs yCM;y-y_{mid};#Delta/#sigma_{#Delta}", 20, -1, 1);
  barlow_vn_yCM_00to10_tr = new TH1D("barlow_vn_yCM_00to10_tr_"+ID, "0-10% de vs yCM;y-y_{mid};#Delta/#sigma_{#Delta}", 20, -1, 1);
  barlow_vn_yCM_10to40_tr = new TH1D("barlow_vn_yCM_10to40_tr_"+ID, "10-40% de vs yCM;y-y_{mid};#Delta/#sigma_{#Delta}", 20, -1, 1);
  barlow_vn_yCM_40to60_tr = new TH1D("barlow_vn_yCM_40to60_tr_"+ID, "40-60% de vs yCM;y-y_{mid};#Delta/#sigma_{#Delta}", 20, -1, 1);
