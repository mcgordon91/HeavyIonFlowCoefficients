...
void RunTreeAnalyzerCumulant(const Char_t *InputFile,  Char_t *JobID, const Char_t *Systematic)
{
    ...
    gSystem->Load("TreeAnalyzerCumulant.so");
    ...
    TreeAnalyzerCumulant *Analyzer = new TreeAnalyzerCumulant(picoMaker, JobID, Systematic);
