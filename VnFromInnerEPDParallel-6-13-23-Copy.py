...
if(os.path.exists("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/HistogramThirdPass.root")):
    RunIteration = 4
elif(os.path.exists("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/HistogramSecondPass.root")):
    RunIteration = 3
elif(os.path.exists("/star/u/mcgordon/VnFromEPD/V" + str(nV) +"Histograms/HistogramFirstPass.root")):
    RunIteration = 2
else:
    RunIteration = 1
...
KaonUpperMSquared = 0.45
PionLowerMSquared = 0
PionUpperMSquared = 0.15
NSigmaPrBound = 3
NSigmaKaBound = 3
NSigmaPiBound = 3
ProtonLowerPt = 0.4
...
if(RunIteration == 1):
    ...
    HistoD31A = ROOT.TH2F("DataPtVsYDeuteron", "Pt vs Y for Deuterons (Data); Y - Y_CM; Pt (Gev)", 500, -1, 1, 1000, 0, 2.5)
    HistoD31A.Sumw2()
    
    HistoD31B = ROOT.TH2F("DataPtVsYTriton", "Pt vs Y for Tritons (Data); Y - Y_CM; Pt (Gev)", 500, -1, 1, 1000, 0, 2.5)
    HistoD31B.Sumw2()
    ...
    HistoD48B = ROOT.TProfile("DataVnVsYPsi1RawInnerEPDDeuteron", "V" + str(nV) + " Observed vs Y for Deuterons, Calculated using Inner EPD (Data); Y - Y_CM; V" + str(nV) +"", 75, -0.3, 0.95)
    HistoD48B.Sumw2()

    HistoD48C = ROOT.TProfile("DataVnVsYPsi1RawInnerEPDTriton", "V" + str(nV) + " Observed vs Y for Deuterons, Calculated using Inner EPD (Data); Y - Y_CM; V" + str(nV) +"", 75, -0.3, 0.95)
    HistoD48C.Sumw2()
...
#                 HistoD31B.Fill(y - yCMShift, pt)
        ...
        for index in range(len(px)):
            ...
            if(IsDeuteron):
                ...
                HistoD48B.Fill(y - yCMShift, VnInnerEPDRaw)
                ...
                HistoD48C.Fill(y - yCMShift, VnInnerEPDRaw)
    ...
    HistoD31A.SetDirectory(0)
    HistoD31B.SetDirectory(0)
    ...
    HistoD48B.SetDirectory(0)
    HistoD48C.SetDirectory(0)
    ...
    Histograms.append(HistoD31A)
    Histograms.append(HistoD31B)
    ...
    Histograms.append(HistoD48B)
    Histograms.append(HistoD48C)
    
    
    Data.Close()

    #QVectorHistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/QVectorHistogramTest.root", "RECREATE")
    QVectorHistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/QVectorFirstPass" + sys.argv[2] + ".root", "RECREATE")
    ...
    #HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root", "RECREATE")
    HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/HistogramFirstPass" + sys.argv[2] + ".root", "RECREATE")
...
if(RunIteration == 2):
    ...
    #QVectorHistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/QVectorHistogramTest.root")
    QVectorHistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/QVectorFirstPass.root")
    #HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root")
    HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/HistogramFirstPass.root")
    ...
    HistoD49B = ROOT.TProfile("DataVnVsYPsi1RecenteredInnerEPDDeuteron", "V" + str(nV) + " Observed vs Y for Deuterons, Calculated using Inner EPD (Data); Y - Y_CM; V" + str(nV) +"", 75, -0.3, 0.95)
    HistoD49B.Sumw2()

    HistoD49C = ROOT.TProfile("DataVnVsYPsi1RecenteredInnerEPDTriton", "V" + str(nV) + " Observed vs Y for Tritons, Calculated using Inner EPD (Data); Y - Y_CM; V" + str(nV) +"", 75, -0.3, 0.95)
    HistoD49C.Sumw2()
    ...
    for entryNum in range (0, AutreeData.GetEntries()):
        ...
        for index in range(len(px)):
            ...
            if(IsDeuteron):
                ...
                HistoD49B.Fill(y - yCMShift, VnInnerEPDRecentered)
                ...
                HistoD49C.Fill(y - yCMShift, VnInnerEPDRecentered)
    ...
    HistoD49B.SetDirectory(0)
    HistoD49C.SetDirectory(0)
    ...
    Histograms.append(HistoD49B)
    Histograms.append(HistoD49C)
    ...
    #QVectorHistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/QVectorHistogramTest.root", "RECREATE")
    QVectorHistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/QVectorSecondPass" + sys.argv[2] + ".root", "RECREATE")
    QVectorHistogramRootFile.cd()
    ...
    #HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root", "RECREATE")
    HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/HistogramSecondPass" + sys.argv[2] + ".root", "RECREATE")
    HistogramRootFile.cd()
...
if(RunIteration == 3):
    ...
    #QVectorHistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/QVectorHistogramTest.root")
    QVectorHistogramFileFirst = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/QVectorFirstPass.root")
    QVectorHistogramFileSecond = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/QVectorSecondPass.root")
    #HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root")
    HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/HistogramSecondPass.root")
    ...
    HistoD50B = ROOT.TProfile("DataVnVsYPsi1RecenteredAndShiftedInnerEPDDeuteron", "V" + str(nV) + " Observed vs Y for Deuterons, Calculated using Inner EPD (Data); Y - Y_CM; V" + str(nV) +"", 75, -0.3, 0.95)
    HistoD50B.Sumw2()

    HistoD50C = ROOT.TProfile("DataVnVsYPsi1RecenteredAndShiftedInnerEPDTriton", "V" + str(nV) + " Observed vs Y for Tritons, Calculated using Inner EPD (Data); Y - Y_CM; V" + str(nV) +"", 75, -0.3, 0.95)
    HistoD50C.Sumw2()
    ...
    for entryNum in range (0, AutreeData.GetEntries()):
        ...
        for index in range(len(px)):
            ...
            if(IsDeuteron):
                ...
                HistoD50B.Fill(y - yCMShift, VnInnerEPDFourierCorrected)
                ...
                HistoD50C.Fill(y - yCMShift, VnInnerEPDFourierCorrected)
    ...
    #HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root", "UPDATE")
    HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/HistogramThirdPass" + sys.argv[2] + ".root", "RECREATE")
    HistogramRootFile.cd()
...
if(RunIteration == 4):
    ...
    QVectorHistogramFileSecond = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/QVectorSecondPass.root")
    #HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root")
    HistogramFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/HistogramThirdPass.root")
    
    HistoD54 = HistogramFile.Get("DataResolution")
    
    CentralityXLabels = ["0-5", "5-10", "10-15", "15-20", "20-25", "25-30", "30-35", "35-40", "40-45", "45-50", "50-55", "55-60"]
    
    HistoD44A = ROOT.TProfile("DataVnVsYPsi1ResolutionCorrectedProton", "V" + str(nV) + " (Resolution Corrected) vs Y for Protons, Calculated using Inner EPD (Data); Y - Y_CM; V" + str(nV) +"", 75, -0.3, 0.95)
    HistoD44A.Sumw2()
        ...
        for index in range(len(px)):
            ...
            if(tofBeta[index] > 0):
                ...
                if((abs(NSigmaPr[index]) < 3) and (msquared > ProtonLowerMSquared) and (msquared < ProtonUpperMSquared) and (pt > ProtonLowerPt) and (pt < ProtonUpperPt)): 
                    ...
                    if(((y - yCMShift) > LowerYMinusYCM) and ((y - yCMShift) < UpperYMinusYCM)):
                        HistoD44A.Fill(y - yCMShift, VnInnerEPDFourierCorrected / ResolutionCorrectionFactor)
    ...
    #HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/HistogramTest.root", "UPDATE")
    HistogramRootFile = ROOT.TFile.Open("/star/u/mcgordon/VnFromEPD/V" + str(nV) + "Histograms/HistogramFourthPass" + sys.argv[2] + ".root", "RECREATE")
    HistogramRootFile.cd()
