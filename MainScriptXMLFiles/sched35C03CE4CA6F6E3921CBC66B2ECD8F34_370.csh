#!/bin/csh
# -------------------------------------- 
# Script generated on Sat Feb 24 13:32:03 EST 2024 by the Simple Unified Meta Scheduler 1.10.50 and submitted with:
# cd /star/u/mcgordon/VnFromEPD/MainScriptXMLFiles; condor_submit -verbose /star/u/mcgordon/VnFromEPD/MainScriptXMLFiles/sched35C03CE4CA6F6E3921CBC66B2ECD8F34_357_456.condor
# --------------------------------------
...
setenv FILEBASENAME "FXT_3p0GeV_SL20d_2018_370"
setenv FILELIST "/star/u/mcgordon/VnFromEPD/MainScriptXMLFiles/sched35C03CE4CA6F6E3921CBC66B2ECD8F34_370.list"
setenv FILELIST_ALL "/star/u/mcgordon/VnFromEPD/MainScriptXMLFiles/sched35C03CE4CA6F6E3921CBC66B2ECD8F34.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "35C03CE4CA6F6E3921CBC66B2ECD8F34_370"
setenv JOBINDEX "370"
setenv LOGGING "STD"
setenv REQUESTID "35C03CE4CA6F6E3921CBC66B2ECD8F34"
...
setenv SUBMIT_TIME "2024-02-24 18:32:03"
...
setenv INPUTFILE0 "/star/data01/pwg/cracz/Data_3p0GeV_FXT/FXT_3p0GeV_SL20d_2018_370.root"
...
#import packages 
/usr/bin/unzip /star/u/mcgordon/VnFromEPD/MainScriptXMLFiles/sched35C03CE4CA6F6E3921CBC66B2ECD8F34_0.package.zip -d $SCRATCH
...
# User command BEGIN ----------------------------->
    ...
    starver SL20d
    VnFromInnerEPD-V3 $INPUTFILE0 $JOBID NSigmaProton30High
