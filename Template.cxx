...
if(RunIteration == 1)
{
    ...
    //                     HistoD27->Fill(y - yCMShift, pt);
        ...
        for (int index = 0; index < nEPDHits; index++)
        {
            ...
            TileVector *TVec (EPDID, vx, vy, vz, InnerEPDHighRing, OuterEPDLowRing);
...
if((RunIteration == 3) || (RunIteration == 4))
        {
            ...
            double InnerEPDQxMean = InnerEPDQxMeanHisto->GetMean();
            double InnerEPDQyMean = InnerEPDQyMeanHisto->GetMean();
            double OuterEPDQxMean = OuterEPDQxMeanHisto->GetMean();
            double OuterEPDQyMean = OuterEPDQyMeanHisto->GetMean();
            double OuterTPCQxMean = OuterTPCQxMeanHisto->GetMean();
            double OuterTPCQyMean = OuterTPCQyMeanHisto->GetMean();
        }